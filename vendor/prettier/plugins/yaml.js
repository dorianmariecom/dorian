(function (f) {
  ...
  var rr = (t, e, n) => (
    ...
    vi = (t) => nr(yt({}, "__esModule", { value: !0 }), t);
  var le = ee((U) => {
    "use strict";
    var re = {
        ANCHOR: "&",
...
` &&
    ...
    function vn(t) {
      ...
      if (!(e instanceof Ft)) return null;
      ...
      we = class t extends V {
        ...
        toJSON(e, n) {
          ...
          if (
            s >= 0 &&
            ((i.count += 1),
            i.aliasCount === 0 && (i.aliasCount = Ut(this.source, r)),
...
`),
      ...
      return (a = c ? a + i.slice(c) : i), n ? a : jt(a, o, Kt, qn(e));
    }
    function qs(t, e) {
      if (e.implicitKey) {
...
${n}`,
          ...
          "'";
      return e.implicitKey ? r : jt(r, n, Fs, qn(e));
    }
    function Vt({ comment: t, type: e, value: n }, r, s, i) {
      if (/\n[\t ]+$/.test(n) || /^\s*$/.test(n)) return Se(n, r);
      let o = r.indent || (r.forceBlockIndent || Qt(n) ? "  " : ""),
        a = o ? "2" : "1",
        c =
...
`) !== -1
        ...
        return Vt(t, e, n, r);
      if (l === "" && Qt(o)) return (e.forceBlockIndent = !0), Vt(t, e, n, r);
      let m = o.replace(
        /\n+/g,
        `$&
${l}`,
      ...
      if (a) {
        ...
        if (typeof Fn(m, y, y.scalarFallback).value != "string")
          return Se(o, e);
      }
      let d = c ? m : jt(m, l, Fs, qn(e));
      return s &&
        !f &&
        (d.indexOf(`
`) !== -1 ||
...
${a}`
    ...
    function Qo(t, e) {
      ...
      for (let o = 0; o < r.length; ++o) {
        let { key: a } = r[o];
        if (
          (a instanceof W && (i = !0), t.schema.merge && a && a.value === $s)
        ) {
          r[o] = new Wt(r[o]);
    ...
    var j = le(),
      ...
      ta = {
        ...
        stringify: ({ comment: t, type: e, value: n }, r, s, i) => {
          ...
          if (
            (e || (e = O.binaryOptions.defaultType), e === j.Type.QUOTE_DOUBLE)
          )
            n = o;
          else {
...
${i.comment}`
  ...
  var Hn = ee((ci) => {
    ...
    var Xt = {
      ...
      Jn = [gt, Xt, da],
      zt = (t) => typeof t == "bigint" || Number.isInteger(t),
      Gn = (t, e, n) => (E.intOptions.asBigInt ? BigInt(t) : parseInt(e, n));
    function zs(t, e, n) {
      let { value: r } = t;
      return zt(r) && r >= 0 ? n + r.toString(e) : E.stringifyNumber(t);
    }
    var Zs = {
        identify: (t) => t == null,
      ...
      ai = [
        ...
        },
        {
          ...
          stringify: ({ value: t }) =>
            Hs(t) ? t.toString() : JSON.stringify(t),
        },
        {
          identify: (t) => typeof t == "number",
          default: !0,
    ...
    function Na(t, e, n) {
      ...
      if (!c) {
        ...
        c = t instanceof Map ? gt : t[Symbol.iterator] ? Xt : gt;
      }
    ...
    Ht._defineProperty(dt, "defaultPrefix", Ht.defaultTagPrefix);
    Ht._defineProperty(dt, "defaultTags", Ht.defaultTags);
    ci.Schema = dt;
  });
  var pi = ee((nn) => {
    "use strict";
      ...
      en = (t, e) => {
        if (t && typeof t == "object") {
          ...
          t instanceof S.Collection
            ? (n && (e[n] = !0), t.items.forEach((r) => en(r, e)))
            : t instanceof S.Pair
              ? (en(t.key, e), en(t.value, e))
              : t instanceof S.Scalar && n && (e[n] = !0);
        }
        return e;
      },
      ka = (t) => Object.keys(en(t, {}));
    function va(t, e) {
      let n = { before: [], after: [] },
        r,
        s = !1;
...
`
    ...
    Y._defineProperty(tn, "defaults", ui);
    nn.Document = tn;
    nn.defaultOptions = Aa;
    nn.scalarOptions = Ta;
  });
  var gi = ee((hi) => {
    "use strict";
  ...
  var je = "string",
    ...
    Ze = "label",
    Me = "break-parent",
    St = new Set([Je, Ge, Oe, He, Le, Ae, Te, Xe, Ce, ze, te, Ze, Me]);
  function Pi(t) {
...
` && n++,
  ...
  function Tt(t) {
    return Ie(t.children) ? Tt(x(!1, t.children, -1)) : t;
  }
  function wr(t) {
...
`);
  ...
  var io = {
      bracketSpacing: kt.bracketSpacing,
      singleQuote: kt.singleQuote,
      proseWrap: kt.proseWrap,
    },
    _r = io;
  var er = {};
  tr(er, { yaml: () => Qa });
...
`,
    ...
    Rr = (function () {
      function t(e) {
        ...
        for (var n = [0], r = 0; r < e.length; )
          switch (e[r]) {
            case vt:
              (r += vt.length), n.push(r);
              break;
            case xr:
              (r += xr.length), e[r] === vt && (r += vt.length), n.push(r);
              break;
            default:
              r++;
              break;
  ...
  function fo(t, e, n) {
    let r = _t(n.text.slice(t.valueRange.origEnd), /^\.\.\./),
      s =
  ...
  function po(t, e, n) {
    let r = _t(n.text.slice(0, t.valueRange.origStart), /---\s*$/);
    r > 0 && !/[\r\n]/.test(n.text[r - 1]) && (r = -1);
    let s =
      r === -1
  ...
  function is(t, e, n) {
    return { ...xt(t, e, n), type: "flowMapping" };
  }
  function Rt(t, e, n) {
  ...
  function os(t, e) {
    let n = ce(t.cstNode.items, e),
      ...
      s = t.items.map((a, c) => {
        let l = r[c],
          { additionalKeyRange: f, additionalValueRange: m } = Dt(l);
        return De(a, e, Rt, f, m);
      }),
      i = n[0],
      o = q(n);
    return is(
  ...
  function as(t, e, n) {
    return { ...xt(t, e, n), type: "flowSequence" };
  }
  function cs(t, e) {
  ...
  var Si = rr(yi(), 1);
  var J = rr(Ei(), 1),
    Bm = J.default.findPair,
    $m = J.default.toJSON,
    Fm = J.default.parseMap,
    qm = J.default.parseSeq,
    Um = J.default.stringifyNumber,
    Km = J.default.stringifyString,
    Vm = J.default.Type,
    Ua = J.default.YAMLError,
    Wm = J.default.YAMLReferenceError,
    Zn = J.default.YAMLSemanticError,
    Ka = J.default.YAMLSyntaxError,
    jm = J.default.YAMLWarning;

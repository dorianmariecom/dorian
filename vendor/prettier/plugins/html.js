      ...
      if ((e && typeof e == "object") || typeof e == "function")
        for (let s of si(e))
          !ii.call(t, s) &&
            ...
            lr(t, s, {
              get: () => e[s],
              enumerable: !(n = ni(e, s)) || n.enumerable,
            });
      return t;
    };
...
Expected it to be ${n}.`;
  ...
  function on(t, e) {
    return (
      re(t), { type: fe, contents: t, groupId: e.groupId, negate: e.negate }
    );
  }
  var ne = { type: de };
...
`,
  ...
  function Rn(t) {
    return (
      (t.type === "element" && (!t.namespace || Se(t)) && Dn[t.name]) || An
    );
  }
  function Hi(t) {
...
` ||
  ...
  function ia(t, e) {
    ...
    if (n.startsWith("@") || n.startsWith("v-on:"))
      return (a) => aa(s, a, { parseWithTs: i });
    if (n.startsWith(":") || n.startsWith("v-bind:"))
      return (a) => oa(s, a, { parseWithTs: i });
        ...
        if (!r.isSelfClosing && Tt(r, e)) {
          ...
          return n
            ? async (s, i) => {
                ...
                return (
                  o ||
                    ((u = await s(fr(a), { parser: n, __embeddedInHtml: !0 })),
                    (o = u === "")),
                  [
                    z(r, e),
                    _(rt(t, e, i)),
...
`
  ...
  function ut(t, e = !0) {
    ...
    if (r === -1) {
      if (e)
        throw new Error(
          `Unsupported format "${t}" expecting ":namespace:name"`,
        );
      return [null, t];
    }
  ...
  var Ha = "boolean",
    ...
    Vt = class extends Ht {
      ...
      hasElement(e, r) {
        return r.some((n) => n.name === xr.name) ||
          (e.indexOf("-") > -1 &&
            (kr(e) || Br(e) || r.some((n) => n.name === Tr.name)))
          ? !0
...
`,
  ...
  function Ws(t, e, r, n = {}) {
    ...
    return (
      s.tokenize(),
      new Or(vo(s.tokens), s.errors, s.nonNormalizedIcuExpressions)
    );
  }
  var go = /\r\n?/g;
  function je(t) {
...
`,
      ...
      _tokenizeExpansionForm() {
        ...
        if (Ao(this._cursor.peek()) && this._isInExpansionForm())
...
`
      ...
      _consumeStartTag(e) {
        ...
        this._pushContainer(
          f,
          d instanceof G &&
            this.getTagDefinition(d.name).isClosedByChild(f.name),
        ),
          a
  ...
  var ir = { attrs: !0, children: !0, cases: !0, expression: !0 },
    ...
    ar = class t {
      ...
      setProperty(e, r) {
        if (this[e] !== r) {
          if (
            (e in ir && (r = r.map((n) => this.createChild(n))), !Ks.has(e))
          ) {
            this[e] = r;
            return;
          }
          ...
          for (let g of c.attrs)
            g.namespace ||
              (g.name = A(
                ...
                (y) =>
                  or.has(c.name) &&
                  (or.get("*").has(y) || or.get(c.name).has(y)),
              ));
      },
      R = (c) => {
        c.sourceSpan &&

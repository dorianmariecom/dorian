(function (f) {
  ...
  var Hs = (a, t) => () => (
    ...
    Ws = (a, t) => {
      for (var e in t) Se(a, e, { get: t[e], enumerable: !0 });
    },
    kt = (a, t, e, s) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let i of qs(t))
          !Ks.call(a, i) &&
            ...
            Se(a, i, {
              get: () => t[i],
              enumerable: !(s = Vs(t, i)) || s.enumerable,
            });
      return a;
    };
  var vt = (a, t, e) => (
      ...
      kt(
        t || !a || !a.__esModule
          ? Se(e, "default", { value: a, enumerable: !0 })
          : e,
        a,
      )
    ),
    Js = (a) => kt(Se({}, "__esModule", { value: !0 }), a);
  var At = Hs((xe) => {
    "use strict";
    ...
    var Lt = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED",
      Xs = {
...
- Did you mean \`import { "${a}" as foo }\`?`,
    ...
    function si(a) {
      ...
      return function s(i, r) {
        ...
        return (
          ...
          "missingPlugin" in r &&
            Object.assign(n, { missingPlugin: r.missingPlugin }),
          Mt(n, "clone", function (h = {}) {
            var c;
    ...
    var p = Object.assign({}, j(Xs), j(Gs), j(Ys), j`pipelineOperator`(Zs)),
      { defineProperty: ii } = Object,
      Ot = (a, t) => {
        a && ii(a, t, { enumerable: !1, value: a[t] });
      };
    function oe(a) {
    ...
    var ri = (a) =>
        class extends a {
          ...
          parseMethod(e, s, i, r, n, o, h = !1) {
            ...
            return (
              (c.kind = e.kind),
              (c = super.parseMethod(c, s, i, r, n, o, h)),
    ...
    function P(a, t = {}) {
      ...
      return (
        ++ue,
        ft.push(a),
        dt.push((e = t.binop) != null ? e : -1),
        mt.push((s = t.beforeExpr) != null ? s : !1),
        yt.push((i = t.startsExpr) != null ? i : !1),
        xt.push((r = t.prefix) != null ? r : !1),
        U.push(new ve(a, t)),
        ue
      );
    }
    ...
    var ni = {
      ...
      incDec: P("++/--", { prefix: q, postfix: ai, startsExpr: m }),
      ...
      _do: A("do", { isLoop: $e, beforeExpr: b }),
      _for: A("for", { isLoop: $e }),
      _while: A("while", { isLoop: $e }),
        ...
        : a <= 90
          ...
          : a < 97
            ...
            : a <= 122
              ? !0
              : a <= 65535
                ? a >= 170 && xi.test(String.fromCharCode(a))
                : We(a, Xt);
    }
    function Q(a) {
      return a < 48
    ...
    var Tt = {
      ...
      Ti = new Set(Tt.keyword),
      bi = new Set(Tt.strict),
      Ai = new Set(Tt.strictBind);
    function Gt(a, t) {
    ...
    var de = class {
      ...
      me = class {
        ...
        isRedeclaredInScope(t, e, s) {
          ...
          return s & 16
            ? (i & 2) > 0 ||
                (!this.treatFunctionsAsVarInScope(t) && (i & 1) > 0)
    ...
    var Ye = class extends Ge {
        ...
        finalizeComment(t) {
          ...
          if (t.leadingNode !== null || t.trailingNode !== null)
            t.leadingNode !== null && es(t.leadingNode, e),
              t.trailingNode !== null && Ii(t.trailingNode, e);
          else {
...
`),
    ...
    function Li(a, t, e, s, i, r) {
      let n = !i;
      t++;
      let o = (c) => ({ pos: t, ch: c, lineStart: e, curLine: s }),
        h = a.charCodeAt(t++);
      switch (h) {
        case 110:
          return o(`
`);
        ...
        case 120: {
          let c;
          return (
            ({ code: c, pos: t } = Ze(a, t, e, s, 2, !1, n, r)),
    ...
    function Ze(a, t, e, s, i, r, n, o) {
      let h = t,
        c;
      return (
        ({ n: c, pos: t } = ss(a, t, e, s, 16, i, r, !1, o, !n)),
        c === null && (n ? o.invalidEscapeSequence(h, e, s) : (t = h - 1)),
        { code: c, pos: t }
      );
    }
    function ss(a, t, e, s, i, r, n, o, h, c) {
      let l = t,
        u = i === 16 ? Rt.hex : Rt.decBinOct,
        f = i === 16 ? Ce.hex : i === 10 ? Ce.dec : i === 8 ? Ce.oct : Ce.bin,
        d = !1,
        y = 0;
    ...
    function is(a, t, e, s, i, r) {
      ...
      } else ({ code: o, pos: t } = Ze(a, t, e, s, 4, !1, i, r));
      return { code: o, pos: t };
    }
    function ce(a, t, e) {
      return new F(e, a - t, a);
    }
    var Di = new Set([103, 109, 115, 105, 121, 117, 100, 118]),
      O = class {
        constructor(t) {
          (this.type = t.type),
            (this.value = t.value),
      ...
      et = class extends Ye {
            ...
            (this.errorHandlers_readInt = {
              invalidDigit: (s, i, r, n) =>
                this.options.errorRecovery
                  ? (this.raise(p.InvalidDigit, ce(s, i, r), { radix: n }), !0)
                  : !1,
        ...
        skipBlockComment(t) {
          ...
          for (
            this.state.pos = i + t.length, we.lastIndex = s + 2;
            we.test(this.input) && we.lastIndex <= i;

          )
            ++this.state.curLine, (this.state.lineStart = we.lastIndex);
        ...
        skipLineComment(t) {
          ...
          if (this.state.pos < this.length)
            for (; !fe(i) && ++this.state.pos < this.length; )
        ...
        readToken_interpreter() {
          ...
          if (t !== 33) return !1;
          let e = this.state.pos;
          for (this.state.pos += 1; !fe(t) && ++this.state.pos < this.length; )
            ...
            if (Di.has(c))
              c === 118
                ...
                : c === 117 &&
                  o.includes("v") &&
                  this.raise(p.IncompatibleRegExpUVFlags, h()),
                o.includes(l) && this.raise(p.DuplicateRegExpFlags, h());
        ...
        readRadixNumber(t) {
          ...
          if (_(this.codePointAtPos(this.state.pos)))
        ...
        readNumber(t) {
          ...
          if (
            ...
            (l === 69 || l === 101) &&
              ...
              (l = this.input.charCodeAt(this.state.pos))),
            l === 110 &&
              ((i || c) && this.raise(p.InvalidBigIntLiteral, s),
              ++this.state.pos,
              (r = !0)),
            l === 109 &&
              (this.expectPlugin("decimal", this.state.curPosition()),
              (o || c) && this.raise(p.InvalidDecimal, s),
              ++this.state.pos,
              (n = !0)),
            _(this.codePointAtPos(this.state.pos)))
          )
            throw this.raise(p.NumberIdentifier, this.state.curPosition());
        ...
        raise(t, e, s = {}) {
          let i = e instanceof F ? e : e.loc.start,
            r = t(i, s);
    ...
    var at = class extends et {
        ...
        initializeScopes(t = this.options.sourceType === "module") {
          ...
          return (
            (this.expressionScope = new it(this)),
            () => {
              (this.state.labels = e),
      ...
      qi = (a) =>
        class extends a {
          ...
          flowParseDeclareExportDeclaration(e, s) {
            ...
            if (
              ...
              throw this.raise(
                ...
                this.state.startLoc,
                { unsupportedExportKind: i, suggestion: ji[i] },
              );
            }
            if (
              this.match(74) ||
          ...
          flowParseInterfaceish(e, s) {
            ...
            if (s) {
              if (
                ((e.implements = []), (e.mixins = []), this.eatContextual(117))
              )
          ...
          checkReservedType(e, s, i) {
            Ui.has(e) &&
              this.raise(
                i ? g.AssignReservedType : g.UnexpectedReservedType,
                s,
                { reservedType: e },
              );
          }
          ...
          flowParseObjectType({
            ...
            for (
              s && this.match(6)
                ? (this.expect(6), (c = 9), (l = !0))
                : (this.expect(5), (c = 8), (l = !1)),
                h.exact = l;
              !this.match(c);
              ...
              if (r && this.isContextual(118)) {
                ...
                I.type !== 14 &&
                  I.type !== 17 &&
                  (this.next(), (y = this.state.startLoc), (e = !1));
              }
              ...
              if (this.eat(0))
                y != null && this.unexpected(y),
                  this.eat(0)
                    ...
                    : h.indexers.push(this.flowParseObjectTypeIndexer(L, d, S));
                ...
                let Ae = this.flowParseObjectTypeProperty(
                  L,
                  d,
                  y,
                  S,
                ...
                Ae === null
                  ? ((u = !0), (E = this.state.lastTokStartLoc))
                  : h.properties.push(Ae);
              }
              this.flowObjectTypeSemicolon(),
                E &&
                  !this.match(8) &&
                  !this.match(9) &&
                  this.raise(g.UnexpectedExplicitInexactInObject, E);
            }
          ...
          shouldParseExportDeclaration() {
            ...
            return Ft(e) || (this.shouldParseEnums() && e === 126)
              ? !this.state.containsEsc
          ...
          parseConditional(e, s, i) {
            ...
            let r = this.state.clone(),
              ...
              { consequent: h, failed: c } =
                this.tryParseConditionalConsequent(),
              [l, u] = this.getArrowLikeExpressions(h);
            if (c || u.length > 0) {
              let f = [...n];
              if (u.length > 0) {
          ...
          getArrowLikeExpressions(e, s) {
            ...
            return s
              ...
              : $i(r, (n) => n.params.every((o) => this.isAssignable(o, !0)));
          }
              ...
              : this.state.inType && (e === 62 || e === 60)
                ...
                : this.state.inType && e === 63
                  ? s === 46
                    ? this.finishOp(18, 2)
                    : this.finishOp(17, 1)
                  : wi(e, s, this.input.charCodeAt(this.state.pos + 2))
          ...
          parseAssignableListItemTypes(e) {
            return (
              this.eat(17) &&
                ...
                this.isThisParam(e) &&
                  this.raise(g.ThisParamMayNotBeOptional, e),
                (e.optional = !0)),
              this.match(14)
                ? (e.typeAnnotation = this.flowParseTypeAnnotation())
                : this.isThisParam(e) &&
          ...
          parseImportSpecifier(e, s, i, r, n) {
            ...
            if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
              ...
              h !== null && !M(this.state.type)
                ? ((e.imported = u), (e.importKind = h), (e.local = $(u)))
                : ((e.imported = o),
                  (e.importKind = null),
              ...
              this.eatContextual(93)
                ? (e.local = this.parseIdentifier())
                : ((c = !0), (e.local = $(e.imported)));
            }
            let l = _t(e);
            return (
              i && l && this.raise(g.ImportTypeShorthandOnlyInPureImport, e),
              (i || l) &&
            ...
            if (((i = n) != null && i.error) || this.match(47)) {
              ...
              let c,
                l = this.tryParse((f) => {
                  ...
                  return (
                    E.type !== "ArrowFunctionExpression" && f(),
                    (E.typeParameters = c),
                    this.resetStartLocationFromNode(E, c),
                    y
                  );
                }, r),
                u = null;
              if (
                l.node &&
                this.maybeUnwrapTypeCastExpression(l.node).type ===
                  "ArrowFunctionExpression"
              ) {
              ...
              throw (h = n) != null && h.thrown
                ...
                : l.thrown
                  ? l.error
                  : this.raise(g.UnexpectedTokenAfterTypeParameter, c);
            }
          ...
          checkParams(e, s, i, r = !0) {
            if (
              !(i && this.state.noArrowParamsConversionAt.includes(e.start))
            ) {
          ...
          flowEnumMembers({ enumName: e, explicitType: s }) {
            ...
            for (; !this.match(8); ) {
              ...
              let o = this.startNode(),
                { id: h, init: c } = this.flowEnumMemberRaw(),
                l = h.name;
              if (l === "") continue;
              /^[a-z]/.test(l) &&
              ...
              switch (((o.id = h), c.type)) {
                case "boolean": {
                  this.flowEnumCheckExplicitTypeMismatch(c.loc, u, "boolean"),
                    (o.init = c.value),
                ...
                case "number": {
                  this.flowEnumCheckExplicitTypeMismatch(c.loc, u, "number"),
                    (o.init = c.value),
                ...
                case "string": {
                  this.flowEnumCheckExplicitTypeMismatch(c.loc, u, "string"),
                    (o.init = c.value),
    ...
    function Y(a) {
      ...
      if (a.type === "JSXMemberExpression")
        return Y(a.object) + "." + Y(a.property);
    ...
    var zi = (a) =>
        class extends a {
          jsxReadToken() {
            ...
            for (;;) {
              if (this.state.pos >= this.length)
                throw this.raise(W.UnterminatedJsxContent, this.state.startLoc);
...
`))
              ...
              case 5:
                return (
                  ...
                  e.expression.type === "JSXEmptyExpression" &&
                    this.raise(W.AttributeIsEmpty, e),
                  e
                );
              case 142:
              case 133:
          ...
          jsxParseElementAt(e) {
            ...
            if (!r.selfClosing) {
              ...
              z(r) && !z(n) && n !== null
                ? this.raise(W.MissingClosingTagFragment, n)
                : !z(r) && z(n)
                  ? this.raise(W.MissingClosingTagElement, n, {
                      openingTagName: Y(r.name),
                    })
                  : !z(r) &&
                    !z(n) &&
                    Y(n.name) !== Y(r.name) &&
            ...
            if (
              ...
              throw this.raise(
                W.UnwrappedAdjacentJSXElements,
                this.state.startLoc,
              );
            return z(r)
      ...
      ht = class extends me {
        ...
        createScope(t) {
          return this.importsStack.push(new Set()), new ot(t);
        }
        enter(t) {
      ...
      Ki = (a, t) => hasOwnProperty.call(a, t) && a[t],
      as = (a) => (a.type === "ParenthesizedExpression" ? as(a.expression) : a),
      lt = class extends nt {
        toAssignable(t, e = !1) {
          var s, i;
          let r;
          switch (
            ...
            case "ObjectExpression":
              ...
              for (let o = 0, h = t.properties.length, c = h - 1; o < h; o++) {
                var n;
                let l = t.properties[o],
                  u = o === c;
                this.toAssignableObjectExpressionProp(l, u, e),
                  u &&
                    l.type === "RestElement" &&
                    (n = t.extra) != null &&
                    n.trailingCommaLoc &&
        ...
        checkIdentifier(t, e, s = !1) {
          this.state.strict &&
            (s ? Zt(t.name, this.inModule) : Qt(t.name)) &&
            (e === 64
            ...
            e & 8192 &&
              t.name === "let" &&
              this.raise(p.LetInLexicalBinding, t),
      ...
      class extends a {
        ...
        tsParseModifiers(
          ...
          let o = (c, l, u, f) => {
              l === u &&
                n[f] &&
                this.raise(x.InvalidModifiersOrder, c, {
                  orderedModifiers: [u, f],
                });
            },
            h = (c, l, u, f) => {
              ((n[u] && l === f) || (n[f] && l === u)) &&
                this.raise(x.IncompatibleModifiers, c, { modifiers: [u, f] });
            };
          for (;;) {
            let { startLoc: c } = this.state,
              l = this.tsParseModifier(e.concat(s ?? []), i);
            if (!l) break;
            $t(l)
              ? n.accessibility
                ? this.raise(x.DuplicateAccessibilityModifier, c, {
                    modifier: l,
                  })
                : (o(c, l, l, "override"),
                  o(c, l, l, "static"),
                  ...
                  (n.accessibility = l))
              : Xi(l)
                ? (n[l] && this.raise(x.DuplicateModifier, c, { modifier: l }),
                  (n[l] = !0),
                  o(c, l, "in", "out"))
                : (hasOwnProperty.call(n, l)
                    ? this.raise(x.DuplicateModifier, c, { modifier: l })
                    : (o(c, l, "static", "readonly"),
                      o(c, l, "static", "override"),
                      o(c, l, "override", "readonly"),
                      o(c, l, "abstract", "override"),
                      h(c, l, "declare", "override"),
                      h(c, l, "static", "abstract")),
                  (n[l] = !0)),
              s != null && s.includes(l) && this.raise(r, c, { modifier: l });
          }
        }
        ...
        tsParseDelimitedList(e, s, i) {
          return Wi(this.tsParseDelimitedListWorker(e, s, !0, i));
        }
        ...
        tsParseImportType() {
          ...
          return (
            ...
            this.expect(10),
            this.match(133) ||
              this.raise(x.UnsupportedImportTypeArgument, this.state.startLoc),
        ...
        tsParseTypeParameters(e) {
          ...
          return (
            ...
            s.params.length === 0 && this.raise(x.EmptyTypeParameters, s),
        ...
        tsParseBindingListForSignature() {
          ...
          for (let s of e) {
            ...
            (i === "AssignmentPattern" || i === "TSParameterProperty") &&
              this.raise(x.UnsupportedSignatureParameterKind, s, { type: i });
          }
          return e;
        }
        ...
        tsIsUnambiguouslyIndexSignature() {
          return (
            this.next(), w(this.state.type) ? (this.next(), this.match(14)) : !1
          );
        }
        ...
        tsParsePropertyOrMethodSignature(e, s) {
          ...
          if (this.match(10) || this.match(47)) {
            ...
            r.kind &&
              this.match(47) &&
              this.raise(
                x.AccesorCannotHaveTypeParameters,
                this.state.curPosition(),
              ),
            ...
            if (r.kind === "get")
              r[n].length > 0 &&
                ...
                this.isThisParam(r[n][0]) &&
                  this.raise(
                    x.AccesorCannotDeclareThisParameter,
                    this.state.curPosition(),
                  ));
            else if (r.kind === "set") {
              if (r[n].length !== 1)
                ...
                this.isThisParam(h) &&
                  ...
                  h.type === "Identifier" &&
                    h.optional &&
                    this.raise(
                      x.SetAccesorCannotHaveOptionalParameter,
                      this.state.curPosition(),
                    ),
                  h.type === "RestElement" &&
                    this.raise(
                      x.SetAccesorCannotHaveRestParameter,
                      this.state.curPosition(),
                    );
              }
          ...
          return (
            e.elementTypes.forEach((i) => {
              ...
              s &&
                ...
                this.raise(x.OptionalTypeBeforeRequired, i),
                s ||
                  (s =
                    (r === "TSNamedTupleMember" && i.optional) ||
                    r === "TSOptionalType");
        ...
        tsParseTupleElementType() {
          ...
          if (c === 58)
            ...
            this.lookaheadCharCode() === 58
              ? ((i = !0),
                (r = this.createIdentifier(this.startNodeAt(l), u)),
                this.expect(17),
                this.expect(14),
                (o = this.tsParseType()))
            ...
            r
              ? ((l = this.startNodeAtNode(r)),
                ...
                this.eat(17) &&
                  ((l.optional = !0),
                  this.raise(
                    x.TupleOptionalAfterType,
                    this.state.lastTokStartLoc,
                  )))
              : ((l = this.startNodeAtNode(o)),
                (l.optional = n),
                this.raise(x.InvalidTupleMemberLabel, o),
                (l.label = o),
                (l.elementType = this.tsParseType())),
              (o = this.finishNode(l, "TSNamedTupleMember"));
          } else if (n) {
        ...
        tsParseTypeOperatorOrHigher() {
          return di(this.state.type) && !this.state.containsEsc
        ...
        tsParseTypeAssertion() {
          this.getPluginOption("typescript", "disallowAmbiguousJSXLike") &&
            this.raise(x.ReservedTypeAssertion, this.state.startLoc);
          let e = this.startNode();
          return (
        ...
        tsParseHeritageClause(e) {
          ...
          return (
            i.length || this.raise(x.EmptyHeritageClauseType, s, { token: e }),
            i
          );
        }
        tsParseInterfaceDeclaration(e, s = {}) {
          ...
          this.expectContextual(129),
            ...
            w(this.state.type)
              ...
              : ((e.id = null),
                this.raise(x.MissingInterfaceName, this.state.startLoc)),
        ...
        tsParseImportEqualsDeclaration(e, s, i) {
          ...
          return (
            e.importKind === "type" &&
              ...
              this.raise(x.ImportAliasHasImportType, r),
            (e.moduleReference = r),
            this.semicolon(),
        ...
        tsParseTypeArguments() {
          ...
          return (
            ...
            e.params.length === 0
              ? this.raise(x.EmptyTypeArguments, e)
              : !this.state.inType &&
        ...
        parseAssignableListItem(e, s) {
          ...
          !(e & 4) &&
            (n || h || o) &&
            this.raise(x.UnexpectedParameterModifier, i);
          ...
          if (n || h || o) {
            ...
            return (
              ...
              l.type !== "Identifier" &&
                ...
                this.raise(x.UnsupportedParameterPropertyKind, u),
              (u.parameter = l),
        ...
        tsDisallowOptionalPattern(e) {
          for (let s of e.params)
            s.type !== "Identifier" &&
              ...
              this.raise(x.PatternIsOptional, s);
        }
        ...
        parseFunctionBodyAndFinish(e, s, i = !1) {
          ...
          return r && !this.match(5) && this.isLineTerminator()
            ...
            : r === "TSDeclareFunction" &&
                this.state.isAmbientContext &&
                (this.raise(x.DeclareFunctionHasImplementation, e), e.declare)
        ...
        tsCheckForInvalidTypeCasts(e) {
          e.forEach((s) => {
            (s == null ? void 0 : s.type) === "TSTypeCastExpression" &&
              this.raise(x.UnexpectedTypeAnnotation, s.typeAnnotation);
          });
        }
        toReferencedList(e, s) {
            ...
            let o,
              h = this.tsTryParseAndCatch(() => {
                ...
                if (
                  l === 48 ||
                  l === 52 ||
                  (l !== 10 && He(l) && !this.hasPrecedingLineBreak())
                )
                  return;
            ...
            if ((o && this.unexpected(o, 10), h))
              return (
                h.type === "TSInstantiationExpression" &&
                  ...
                  this.raise(
                    x.InvalidPropertyAccessAfterInstantiationExpression,
                    this.state.startLoc,
                  ),
                h
              );
        ...
        checkImportReflection(e) {
          super.checkImportReflection(e),
            e.module &&
              e.importKind !== "value" &&
              this.raise(
                x.ImportReflectionHasImportType,
                e.specifiers[0].loc.start,
              );
        }
        ...
        parseImport(e) {
          ...
          return (
            s.importKind === "type" &&
              ...
              this.raise(x.TypeImportCannotSpecifyDefaultAndNamed, s),
            s
          );
        }
        parseExport(e, s) {
          ...
          for (let { id: o, init: h } of n.declarations)
            h &&
              (s !== "const" || o.typeAnnotation
                ? this.raise(x.InitializerNotAllowedInAmbientContext, h)
                : Qi(h, this.hasPlugin("estree")) ||
                  this.raise(
                    x.ConstInitiailizerMustBeStringOrNumericLiteralOrLiteralEnumReference,
                    h,
                  ));
          return n;
        }
            ...
            this.tsIsStartOfStaticBlocks()
              ? (this.next(),
                ...
                this.tsHasSomeModifiers(s, r) &&
                  this.raise(
                    x.StaticBlockCannotHaveModifier,
                    this.state.curPosition(),
                  ),
        ...
        parseClassMemberWithIsStatic(e, s, i, r) {
          ...
          if (n) {
            e.body.push(n),
              s.abstract && this.raise(x.IndexSignatureHasAbstract, s),
              s.accessibility &&
                this.raise(x.IndexSignatureHasAccessibility, s, {
                  modifier: s.accessibility,
                }),
              s.declare && this.raise(x.IndexSignatureHasDeclare, s),
              s.override && this.raise(x.IndexSignatureHasOverride, s);
            return;
          }
          !this.state.inAbstractClass &&
            s.abstract &&
            this.raise(x.NonAbstractClassHasAbstractMethod, s),
            s.override &&
              (i.hadSuperClass || this.raise(x.OverrideNotInSubClass, s)),
        ...
        parsePostMemberNameModifiers(e) {
          this.eat(17) && (e.optional = !0),
            e.readonly &&
              this.match(10) &&
              this.raise(x.ClassMethodHasReadonly, e),
            e.declare &&
              this.match(10) &&
              this.raise(x.ClassMethodHasDeclare, e);
        }
        parseExpressionStatement(e, s, i) {
          return (
            (s.type === "Identifier"
        ...
        parseExportDeclaration(e) {
          ...
          if (
            ...
            throw this.raise(
              x.ExpectedAmbientAfterExportDeclare,
              this.state.startLoc,
            );
          let n =
        ...
        parseClassProperty(e) {
          if (
            ...
            this.state.isAmbientContext &&
              ...
              this.match(29) &&
              this.raise(
                x.DeclareClassFieldHasInitializer,
                this.state.startLoc,
              ),
        ...
        parseClassPrivateProperty(e) {
          return (
            e.abstract && this.raise(x.PrivateElementHasAbstract, e),
            e.accessibility &&
              this.raise(x.PrivateElementHasAccessibility, e, {
        ...
        parseClassAccessorProperty(e) {
          return (
            this.parseClassPropertyAnnotation(e),
            e.optional && this.raise(x.AccessorCannotBeOptional, e),
        ...
        pushClassMethod(e, s, i, r, n, o) {
          ...
          let { declare: c = !1, kind: l } = s;
          c &&
            (l === "get" || l === "set") &&
            this.raise(x.DeclareAccessor, s, { kind: l }),
        ...
        parseMaybeAssign(e, s) {
          ...
          if (this.hasPlugin("jsx") && (this.match(142) || this.match(47))) {
            if (
              ((c = this.state.clone()),
              (l = this.tryParse(() => super.parseMaybeAssign(e, s), c)),
              !l.error)
            )
              return l.node;
          ...
          if (!((i = l) != null && i.error) && !this.match(47))
            return super.parseMaybeAssign(e, s);
            ...
            d = this.tryParse((y) => {
              ...
              return (
                (S.type !== "ArrowFunctionExpression" ||
                  ((E = S.extra) != null && E.parenthesized)) &&
                  y(),
                ((L = f) == null ? void 0 : L.params.length) !== 0 &&
          ...
          if (
            !l &&
            (jt(!this.hasPlugin("jsx")),
            (u = this.tryParse(() => super.parseMaybeAssign(e, s), c)),
            !u.error)
          )
            return u.node;
          if ((r = l) != null && r.node)
        ...
        reportReservedArrowTypeParam(e) {
          ...
          e.params.length === 1 &&
            ...
            this.getPluginOption("typescript", "disallowAmbiguousJSXLike") &&
            this.raise(x.ReservedArrowTypeParam, e);
        }
        parseMaybeUnary(e, s) {
        ...
        toAssignable(e, s = !1) {
          switch (e.type) {
            ...
            case "TSTypeAssertion":
              s
                ? this.expressionScope.recordArrowParameterBindingError(
                    x.UnexpectedTypeCastInParameter,
                    e,
                  )
                : this.raise(x.UnexpectedTypeCastInParameter, e),
        ...
        parseMaybeDefault(e, s) {
          ...
          return (
            i.type === "AssignmentPattern" &&
              i.typeAnnotation &&
              i.right.start < i.typeAnnotation.start &&
              this.raise(x.TypeAnnotationAfterAssign, i.typeAnnotation),
            i
          );
        }
        getTokenFromCode(e) {
        ...
        tsParseAbstractDeclaration(e, s) {
          ...
          if (this.isContextual(129)) {
            if (!this.hasFollowingLineBreak())
              return (
                (e.abstract = !0),
                this.raise(x.NonClassMethodPropertyHasAbstractModifer, e),
        ...
        parseMethod(e, s, i, r, n, o, h) {
          ...
          if (
            ...
            let { key: u } = c;
            this.raise(x.AbstractMethodHasImplementation, c, {
              methodName:
                u.type === "Identifier" && !c.computed
                  ? u.name
        ...
        parseTypeOnlyImportExportSpecifier(e, s, i) {
          ...
          c &&
            ...
            this.raise(
              s
                ? x.TypeModifierIsUsedInTypeImports
                : x.TypeModifierIsUsedInTypeExports,
              u,
            ),
            (e[r] = o),
            (e[n] = h);
          ...
          (e[f] = c ? "type" : "value"),
            l &&
              ...
              (e[n] = s
                ...
                : this.parseModuleExportName()),
            e[n] || (e[n] = $(e[r])),
            s && this.checkIdentifier(e[n], c ? 4098 : 4096);
        }
      };
    function Yi(a) {
      ...
      er = (a) =>
        class extends a {
          ...
          isExportDefaultSpecifier() {
            if (this.match(65)) {
              ...
              if (
                ...
                this.input.startsWith(K(144), this.nextTokenStartSince(e + 4))
              )
                return !0;
            }
          ...
          parseImport(e) {
            ...
            if (
              ((e.specifiers = []), !this.isContextual(98) && !this.match(12))
            )
              return (
          ...
          assertNoSpace() {
            this.state.start > this.state.lastTokEndLoc.index &&
              this.raise(Vt.UnexpectedSpace, this.state.lastTokEndLoc);
          }
        },
      tr = (a) =>
        class extends a {
    ...
    var qt = ["minimal", "fsharp", "hack", "smart"],
      zt = ["^^", "@@", "^", "%", "#"];
    function sr(a) {
      if (N(a, "decorators")) {
      ...
      if (N(a, "pipelineOperator")) {
        ...
        let e = ["recordAndTuple", { syntaxType: "hash" }],
          s = N(a, e);
        if (t === "hack") {
          if (N(a, "placeholders"))
            throw new Error(
          ...
          if (i === "#" && s)
            throw new Error(
              `Plugin conflict between \`["pipelineOperator", { proposal: "hack", topicToken: "#" }]\` and \`${JSON.stringify(e)}\`.`,
            );
        } else if (t === "smart" && s)
          throw new Error(
            `Plugin conflict between \`["pipelineOperator", { proposal: "smart" }]\` and \`${JSON.stringify(e)}\`.`,
          );
      }
      ...
      if (
        N(a, "optionalChainingAssign") &&
        J(a, "optionalChainingAssign", "version") !== "2023-07"
      )
        throw new Error(
    ...
    var ct = class extends lt {
        ...
        parseExprOp(t, e, s) {
          if (this.isPrivateName(t)) {
            ...
            (s >= Ie(58) || !this.prodParam.hasIn || !this.match(58)) &&
        ...
        parseCoverCallAndAsyncArrowHead(t, e, s, i) {
          ...
          h && (this.expressionScope.enter(Fi()), (n = new Z())),
            c && (o.optional = i),
            i
        ...
        parseTaggedTemplateExpression(t, e, s) {
          ...
          return (
            ...
            s.optionalChainMember &&
              this.raise(p.OptionalChainingNoTemplate, e),
          ...
          for (this.state.inFSharpPipelineDirectBody = !1; !this.eat(t); ) {
            if (o) o = !1;
              ...
              e &&
                ...
                !this.hasPlugin("moduleAttributes") &&
                this.raise(
                  p.ImportCallArgumentTrailingComma,
                  this.state.lastTokStartLoc,
                ),
        ...
        finishTopicReference(t, e, s, i) {
          if (this.testTopicReferenceConfiguration(s, e, i)) {
            ...
            throw this.raise(p.PipeTopicUnconfiguredToken, e, { token: K(i) });
        }
        ...
        parseAsyncArrowUnaryFunction(t) {
          this.prodParam.enter(ke(!0, this.prodParam.hasYield));
          let e = [this.parseIdentifier()];
          return (
            this.prodParam.exit(),
            this.hasPrecedingLineBreak() &&
        ...
        parseImportMetaProperty(t) {
          ...
          if ((this.next(), this.isContextual(101)))
            ...
            if (
              (s || this.unexpected(),
              this.expectPlugin(
                s ? "sourcePhaseImports" : "deferredImportEvaluation",
              ),
              !this.options.createImportExpressions)
            )
              throw this.raise(
                p.DynamicImportPhaseRequiresImportExpressions,
                this.state.startLoc,
                { phase: this.state.value },
              );
            return (
              this.next(),
              (t.phase = s ? "source" : "defer"),
        ...
        parseTemplateElement(t) {
          ...
          let h = this.match(24),
            ...
            l = i + c;
          (o.value = {
            raw: this.input.slice(n, l).replace(
              /\r\n?/g,
              `
`,
            ),
        ...
        parseObjectLike(t, e, s, i) {
          ...
          for (h.properties = [], this.next(); !this.match(t); ) {
            ...
            e
              ...
              : ((l = this.parsePropertyDefinition(i)),
                this.checkProto(l, s, n, i)),
              s &&
                !this.isObjectProperty(l) &&
                l.type !== "SpreadElement" &&
                this.raise(p.InvalidRecordProperty, l),
        ...
        checkGetterSetterParams(t) {
          ...
          i.length !== s &&
            this.raise(
              t.kind === "get" ? p.BadGetterArity : p.BadSetterArity,
              t,
            ),
            t.kind === "set" &&
        ...
        parseObjectProperty(t, e, s, i) {
          ...
          if (!t.computed && t.key.type === "Identifier") {
            if (
              ...
              t.value = this.parseMaybeDefault(e, $(t.key));
        ...
        parseMethod(t, e, s, i, r, n, o = !1) {
          this.initFunction(t, s),
            ...
            this.prodParam.enter(ke(s, t.generator)),
        ...
        parseFunctionBody(t, e, s = !1) {
          ...
          if ((this.expressionScope.enter(rs()), i))
            ...
            (this.state.labels = []),
              ...
              (t.body = this.parseBlock(!0, !1, (o) => {
                ...
                this.checkParams(t, !this.state.strict && !e && !s && !h, e, c),
                  this.state.strict &&
                    t.id &&
                    this.checkIdentifier(t.id, 65, c);
              })),
              this.prodParam.exit(),
              (this.state.labels = n);
          }
        ...
        parseImportCall(t) {
          return (
            ...
            this.eat(12) &&
              (this.expectImportAttributesPlugin(),
              this.match(11) ||
                ((t.options = this.parseMaybeAssignAllowIn()), this.eat(12))),
            this.expect(11),
    ...
    var pt = class extends ct {
        parseTopLevel(t, e) {
          return (
            ...
            (t.comments = this.comments),
            this.options.tokens && (t.tokens = or(this.tokens, this.input)),
        ...
        startsUsingForOf() {
          ...
          if (t === 102 && !e) return !1;
          if (w(t) && !this.hasFollowingLineBreak())
        ...
        parseStatementContent(t, e) {
          ...
          switch (s) {
            ...
            case 100: {
              ...
              let l = this.nextTokenStart(),
                u = this.codePointAtPos(l);
              if (
                u !== 91 &&
                ((!r && this.hasFollowingLineBreak()) ||
                  (!this.chStartsBindingIdentifier(u, l) && u !== 123))
              )
                break;
            }
            case 75:
          ...
          return w(s) && c.type === "Identifier" && this.eat(14)
            ? this.parseLabeledStatement(i, h, c, t)
            : this.parseExpressionStatement(i, c, e);
        }
        ...
        parseForStatement(t) {
          ...
          let s = this.isContextual(100);
          {
            let h = this.isContextual(96) && this.startsAwaitUsing(),
              ...
              l = (s && this.hasFollowingBindingAtom()) || c;
        ...
        parseLabeledStatement(t, e, s, i) {
          for (let n of this.state.labels)
            n.name === e &&
              this.raise(p.LabelRedeclaration, s, { labelName: e });
        ...
        parseFunction(t, e = 0) {
          ...
          return (
            (this.state.maybeInArrowParameters = !1),
            this.scope.enter(2),
            this.prodParam.enter(ke(n, t.generator)),
        ...
        parseClassMemberWithIsStatic(t, e, s, i) {
          ...
          if ((this.parsePostMemberNameModifiers(u), this.isClassMethod())) {
            ...
            this.parseClassElementName(o),
              this.pushClassAccessorProperty(t, c, S);
          } else
            this.isLineTerminator()
              ? E
                ? this.pushClassPrivateProperty(t, h)
        ...
        parseExport(t, e) {
          ...
          i && r && !n && !l && this.unexpected(null, 5),
        ...
        parseExportSpecifier(t, e, s, i) {
          return (
            this.eatContextual(93)
              ...
              : e
                ? (t.exported = Ri(t.local))
                : t.exported || (t.exported = $(t.local)),
        ...
        parseMaybeImportPhase(t, e) {
          ...
          let s = this.parseIdentifier(!0),
            { type: i } = this.state;
          return (
            M(i) ? i !== 98 || this.lookaheadCharCode() === 102 : i !== 12
          )
      ...
      Me = class extends pt {
        constructor(t, e) {
          (t = rr(t)),
            ...
            (this.plugins = hr(this.options.plugins)),
    ...
    function pe(a, t) {
      let e = Me;
      return (
        a != null && a.plugins && (sr(a.plugins), (e = fr(a.plugins))),
        new e(a, t)
      );
    }
    var Kt = {};
    function fr(a) {
      let t = ir.filter((i) => N(a, i)),
        e = t.join("/"),
        s = Kt[e];
      if (!s) {
        s = Me;
...
` ||
  ...
  function xr(a, t) {
    let e = null,
      s = t;
    for (; s !== e; )
      (e = s), (s = ls(a, s)), (s = ps(a, s)), (s = fs(a, s)), (s = us(a, s));
    return s;
  }
  var ds = xr;
  function Pr(a) {
...
`);
  ...
  function D(a) {
    ...
    let t = ((s = a.range) == null ? void 0 : s[0]) ?? a.start,
      e =
        (r =
          ((i = a.declaration) == null ? void 0 : i.decorators) ??
          a.decorators) == null
          ? void 0
          : r[0];
  ...
  var ys = Ar;
  var Sr = ys(["Block", "CommentBlock", "MultiLine"]),
    ge = Sr;
  function wr(a) {
    let t = `*${a.value}*`.split(`
`);
  ...
  function Cr(a) {
    return (
      ge(a) && a.value[0] === "*" && /@(?:type|satisfies)\b/u.test(a.value)
    );
  }
  var xs = Cr;
  var Te = null;
  function be(a) {
    ...
    return (Te = be.prototype = a ?? Object.create(null)), new be();
  }
  var Er = 10;
      ...
      (a = Be(a, (r) => {
        ...
        (a = Be(a, (r) => {
          if (r.type === "ParenthesizedExpression") {
            ...
            let o = D(r);
            if (!i.has(o))
              return (n.extra = { ...n.extra, parenthesized: !0 }), n;
          }
        }));
    }
    if (
      ((a = Be(a, (i) => {
        ...
        switch (i.type) {
          ...
          case "ExportAllDeclaration":
            if (
              e === "meriyah" &&
              ((r = i.exported) == null ? void 0 : r.type) === "Identifier"
            ) {
              let { exported: n } = i,
                o = s.slice(D(n), B(n));
  ...
  function Lr(a) {
    ...
    return (
      ...
      Re(t, { loc: { start: { line: e, column: s + 1 } }, cause: r })
    );
  }
  var Ue = Lr;
  var Dr = (a, t, e, s) => {
  ...
  function Es(a) {
    let t = `
`;
    a = ie(!1, a.replace(Or, "").replace(Mr, ""), Ur, "$1");
    let e = "";
    for (; e !== a; ) (e = a), (a = ie(!1, a, Rr, `${t}$1 $2${t}`));
    a = a.replace(Ss, "").trimEnd();
    let s = Object.create(null),
      i = ie(!1, a, ws, "").replace(Ss, "").trimEnd(),
      r;
    for (; (r = ws.exec(a)); ) {
      let n = ie(!1, r[2], Br, "");
  ...
  function $r(a) {
    return (
      ...
      { astFormat: "estree", hasPragma: Is, locStart: D, locEnd: B, ...a }
    );
  }
  var G = $r;
  function Vr(a) {
  ...
  var re = (a) => G(Jr(a)),
    ...
    V = (a, t = zr) => ({ ...t, plugins: [...t.plugins, ...a] }),
    Kr = /@(?:no)?flow\b/u;
  function Hr(a, t) {
    var i;
    ...
    let s = ds(a, 0);
    return s !== !1 && (a = a.slice(0, s)), Kr.test(a);
  }
  function Wr(a, t, e) {
    let s = a(t, e),
  ...
  function Jr({ isExpression: a = !1, optionsCombinations: t }) {
    return (e, s = {}) => {
      if ((s.parser === "babel" || s.parser === "__babel_estree") && Hr(e, s))
        return (s.parser = "babel-flow"), Bs.parse(e, s);
      let i = t;
      (s.__babelSourceType ?? Ns(s)) === "script" &&
        (i = i.map((c) => ({ ...c, sourceType: "script" })));
      let n = /%[A-Z]/u.test(e);
      e.includes("|>")
        ? (i = (n ? [...vs, ks] : vs).flatMap((l) => i.map((u) => V([l], u))))
        : n && (i = i.map((c) => V([ks], c)));
      let o = a ? je.parseExpression : je.parse,
        h;
      try {
      ...
      return (
        a && (h = _e(h, { text: e, rootMarker: s.rootMarker })),
        As(h, { parser: "babel", text: e })
      );
    };
  }
  var Xr = new Set([
    ...
    Fs = [V(["jsx"])],
    Ls = re({ optionsCombinations: Fs }),
    Ds = re({
      optionsCombinations: [V(["jsx", "typescript"]), V(["typescript"])],
    }),
    Ms = re({ isExpression: !0, optionsCombinations: [V(["jsx"])] }),
    Os = re({ isExpression: !0, optionsCombinations: [V(["typescript"])] }),
    Bs = re({
      optionsCombinations: [
        V(["jsx", ["flow", { all: !0, enums: !0 }], "flowComments"]),
      ],
    }),
    Gr = re({ optionsCombinations: Fs.map((a) => V(["estree"], a)) }),
    Rs = {
      babel: Ls,
      "babel-flow": Bs,
      "babel-ts": Ds,
      ...
      __ts_expression: Os,
      __vue_expression: Ms,
      __vue_ts_expression: Os,
      __vue_event_binding: Ls,
      __vue_ts_event_binding: Ds,
      __babel_estree: Gr,
    };
  var Us = vt(At(), 1);
  function _s(a = {}) {

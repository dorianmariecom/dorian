(function (f) {
  ...
  var Ar = (e, t) => {
      for (var r in t) In(e, r, { get: t[r], enumerable: !0 });
    },
    Na = (e, t, r, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let s of Ga(t))
          !Ua.call(e, s) &&
            ...
            In(e, s, {
              get: () => t[s],
              enumerable: !(n = Wa(t, s)) || n.enumerable,
            });
      return e;
    };
  var Xa = (e) => Na(In({}, "__esModule", { value: !0 }), e);
  var qs = (e, t, r) => t.has(e) || Js("Cannot " + r);
  var pt = (e, t, r) => (
      qs(e, t, "read from private field"), r ? r.call(e) : t.get(e)
    ),
    Ws = (e, t, r) =>
      t.has(e)
        ? Js("Cannot add the same private member more than once")
        : t instanceof WeakSet
          ? t.add(e)
          : t.set(e, r),
    Gs = (e, t, r, n) => (
      qs(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r
    );
  var om = {};
  Ar(om, { languages: () => am, options: () => va, printers: () => im });
  var Us = [
    {
  ...
  Ar(Os, {
    canAttachComment: () => Ap,
    embed: () => Qu,
    experimentalFeatures: () => em,
    getCommentChildNodes: () => Tp,
    getVisitorKeys: () => gr,
    handleComments: () => zn,
    insertPragma: () => pi,
    isBlockComment: () => re,
  ...
  function* Ka(e, t) {
    ...
    for (let n = 0; n < r.length; n++) {
      let s = r[n];
      for (let u of $a(s, t)) yield u, r.push(u);
    }
  }
...
` ||
  ...
  function R(e) {
    ...
    let t = ((n = e.range) == null ? void 0 : n[0]) ?? e.start,
      r =
        (u =
          ((s = e.declaration) == null ? void 0 : s.decorators) ??
          e.decorators) == null
          ? void 0
          : u[0];
  ...
  var po = 10;
  for (let e = 0; e <= po; e++) Zt();
  function Ln(e) {
    return Zt(e);
  }
  function co(e, t = "type") {
    Ln(e);
    function r(n) {
      let s = n[t],
        u = e[s];
  ...
  var v = mo;
  var yo = v(["Block", "CommentBlock", "MultiLine"]),
    re = yo;
  var Do = v([
      "AnyTypeAnnotation",
      "ThisTypeAnnotation",
  ...
  function St(e, t) {
    ...
    let r = oe(e);
    if (r.length === 1) {
      if (wn(e) && St(t)) return _t(r[0]);
      if (xo(e.callee)) return wn(r[0]);
    } else if (
      (r.length === 2 || r.length === 3) &&
      (r[0].type === "TemplateLiteral" || Q(r[0])) &&
      go(e.callee)
    )
      return r[2] && !Ce(r[2])
        ? !1
        : (r.length === 2 ? _t(r[1]) : Ao(r[1]) && K(r[1]).length <= 1) ||
            wn(r[1]);
    return !1;
  }
  var pu = (e) => (t) => (
...
`),
  ...
  function Lr(e, t) {
    return (
      ((e.type === "TemplateLiteral" && nu(e)) ||
        (e.type === "TaggedTemplateExpression" && nu(e.quasi))) &&
      !te(t, R(e), { backwards: !0 })
    );
  }
  function wr(e) {
    if (!d(e)) return !1;
  ...
  function be(e, t = 2) {
    ...
    if (e.type === "ChainExpression" || e.type === "TSNonNullExpression")
      return be(e.expression, t);
    let r = (n) => be(n, t - 1);
    if (Mn(e)) return et(e.pattern ?? e.regex.pattern) <= 5;
    if (kr(e) || Co(e) || e.type === "ArgumentPlaceholder") return !0;
...
`),
    ...
    return q(e)
      ? be(e.object, t) && be(e.property, t)
      : (e.type === "UnaryExpression" && Bo.has(e.operator)) ||
  ...
  function Rt(e, t) {
    ...
    if (r.type === "ChainExpression")
      return e.call(() => Rt(e, t), "expression");
  ...
  function Jn(e, t) {
    ...
    if (
      ...
      if (t === 0 || t === (e.attributes || e.options ? -2 : -1))
        return [...r, "source"];
  ...
  var g = {
    ...
    Eu = (e, t) => {
      if ((typeof e == "function" && ((t = e), (e = 0)), e || t))
        return (r, n, s) =>
          !(
            (e & g.Leading && !r.leading) ||
            (e & g.Trailing && !r.trailing) ||
            (e & g.Dangling && (r.leading || r.trailing)) ||
            (e & g.Block && !re(r)) ||
            (e & g.Line && !vt(r)) ||
            (e & g.First && n !== 0) ||
            (e & g.Last && n !== s.length - 1) ||
            (e & g.PrettierIgnore && !sr(r)) ||
            (t && !t(r))
          );
    };
  function d(e, t, r) {
  ...
  function Ae(e) {
    return (
      e && (e.type === "ObjectProperty" || (e.type === "Property" && !gt(e)))
    );
  }
  var Te = v([
      "TSAsExpression",
  ...
  function Fu(e, t, r) {
    ...
    if (
      ...
      e.type === "DecimalLiteral" && (t.value = Number(e.value)),
      e.type === "Literal" && t.decimal && (t.decimal = Number(e.decimal)),
    ...
    if (
      ...
      let { key: i } = e;
      Q(i) || Ce(i)
        ? (t.key = String(i.value))
        : i.type === "Identifier" && (t.key = i.name);
    }
    if (
      e.type === "JSXElement" &&
    ...
    e.type === "JSXAttribute" &&
      ...
      e.type === "JSXAttribute" &&
        ...
        (t.value.value = N(!1, e.value.value, /["']|&quot;|&apos;/gu, '"'));
    ...
    e.type === "TaggedTemplateExpression" &&
      ...
      e.type === "TemplateLiteral" &&
        (((u = e.leadingComments) != null &&
          u.some(
            (a) =>
              re(a) && ["GraphQL", "HTML"].some((o) => a.value === ` ${o} `),
          )) ||
...
Expected it to be ${n}.`;
  ...
  function b(e, t = "", r = {}) {
    return (
      Ke(e),
      t !== "" && Ke(t),
      { type: xe, breakContents: e, flatContents: t, groupId: r.groupId }
    );
  }
  function At(e, t) {
    return (
      Ke(e), { type: He, contents: e, groupId: t.groupId, negate: t.negate }
    );
  }
  function Gn(e) {
  ...
  var ke = { type: $e },
    Ee = { type: ve };
  var Un = { type: me, hard: !0 },
    Oo = { type: me, hard: !0, literal: !0 },
    x = { type: me },
    E = { type: me, soft: !0 },
    F = [Un, Ee],
    Rr = [Oo, Ee],
    ...
    switch (ut(e)) {
      ...
      case _e: {
        ...
        for (let r of e) {
          ...
          typeof n == "string" && typeof O(!1, t, -1) == "string"
            ? (t[t.length - 1] += n)
            : t.push(n),
            t.push(...s);
        }
...
`);
  ...
  var zn = {};
  Ar(zn, { endOfLine: () => Yo, ownLine: () => Xo, remaining: () => Ho });
  function qo(e) {
  ...
  function Wo(e, t) {
    let r = null,
      n = t;
    for (; n !== r; )
      (r = n), (n = Ge(e, n)), (n = Lt(e, n)), (n = wt(e, n)), (n = Ue(e, n));
    return n;
  }
  var yt = Wo;
  function Go(e, t) {
...
`
  ...
  function Ho(e) {
    return [Mu, Hn, Vn, zo, np, Ou, Kn, rp, tp, Dp, $n, yp].some((t) => t(e));
  }
  function bt(e, t) {
  ...
  function Vo({ comment: e, followingNode: t }) {
  ...
  function $o({ comment: e, enclosingNode: t, followingNode: r }) {
    return q(t) && (r == null ? void 0 : r.type) === "Identifier"
      ? (ce(t, e), !0)
      : !1;
  }
  function Ko({ comment: e, enclosingNode: t, followingNode: r, options: n }) {
  ...
  function Lu({
    ...
    return (!t || !i) &&
      ...
      ? u.experimentalTernaries &&
        r.alternate === n &&
        !(re(e) && !de(u.originalText, R(e), k(e)))
        ? (Le(r, e), !0)
        : (ce(n, e), !0)
      : !1;
  }
  ...
  function wu({
    ...
    if (Qo.has(r == null ? void 0 : r.type)) {
      if (w(r.decorators) && (n == null ? void 0 : n.type) !== "Decorator")
        return z(O(!1, r.decorators, -1), e), !0;
  ...
  function tp({ comment: e, precedingNode: t, enclosingNode: r, text: n }) {
    return ge(n, k(e)) !== "("
      ? !1
      : t && ep.has(r == null ? void 0 : r.type)
        ? (z(t, e), !0)
        : !1;
  }
  ...
  function np({ comment: e, enclosingNode: t, text: r }) {
    return ge(r, k(e)) !== ")"
      ? !1
      : t && ((Ru(t) && K(t).length === 0) || (lt(t) && oe(t).length === 0))
        ? (Le(t, e), !0)
  ...
  function up({ comment: e, precedingNode: t, enclosingNode: r }) {
    return L(r) && t && r.callee === t && r.arguments.length > 0
      ? (ce(r.arguments[0], e), !0)
      : !1;
  }
  function ip({
    comment: e,
    ...
    return Ne(r)
      ? (sr(e) && ((n.prettierIgnore = !0), (e.unignore = !0)),
        t ? (z(t, e), !0) : !1)
      : (Ne(n) &&
          sr(e) &&
  ...
  function mp({ comment: e, enclosingNode: t, followingNode: r }) {
    return cp.has(t == null ? void 0 : t.type) && r && (lp.has(r.type) || re(e))
      ? (ce(r, e), !0)
      : !1;
  }
  function yp({ comment: e, enclosingNode: t, followingNode: r, text: n }) {
    return !r &&
  ...
  function fp({ comment: e, enclosingNode: t, followingNode: r }) {
    return !t ||
      ...
      r !== t.consequent[0]
      ? !1
      : (r.type === "BlockStatement" && vt(e) ? bt(r, e) : Le(t, e), !0);
  }
  function Ep({
    comment: e,
    precedingNode: t,
    ...
    for (; r >= 0; ) {
      ...
      switch (D) {
        ...
        case le: {
          ...
          let y = m.break ? Se : c,
            C =
              m.expandedStates && y === Se
                ? O(!1, m.expandedStates, -1)
                : m.contents;
          a.push({ mode: y, doc: C });
          break;
        }
...
`,
        ...
        case nt:
          ...
          break;
        case Xe:
          i.push({ ind: xp(y, t), mode: C, doc: p.contents });
          break;
        case Ye:
          i.push({ ind: hp(y, p.n, t), mode: C, doc: p.contents });
          break;
        case st:
          u -= es(a);
          break;
        ...
        case Pe: {
          ...
          let Fe = { ind: y, mode: C, doc: qt(T) },
            H = T[0];
          Jr({ ind: y, mode: at, doc: [S, B, H] }, [], A, c.length > 0, r, !0)
            ? i.push(Fe, h, _)
            : j
              ? i.push(Fe, W, _)
              : i.push(Fe, W, J);
        ...
        case Ve:
          ...
          break;
        case $e:
          c.length > 0 && i.push({ ind: y, mode: C, doc: Un });
          break;
        case me:
          switch (C) {
            case at:
            ...
            case Se:
              if (c.length > 0) {
                i.push({ ind: y, mode: C, doc: p }, ...c.reverse()),
                  (c.length = 0);
                break;
              }
              p.literal
                ? y.root
                  ...
                  : (a.push(s), (u = 0))
                : ((u -= es(a)), a.push(s + y.value), (u = y.length));
              break;
          }
          break;
        case je:
...
`)
  ...
  function Uu(e, t) {
    let r = t("quasi");
    return it(r.label && { tagged: !0, ...r.label }, [
      t("tag"),
...
`) && o.push({ hasLineBreak: !1, cells: [] });
      ...
      for (let { cells: y } of D.filter((C) => !C.hasLineBreak))
        for (let [C, p] of y.entries()) m[C] = Math.max(m[C], et(p));
      return (
        i.push(
          ke,
          "`",
            ...
            P(
              ...
              D.map((y) =>
                P(
                  " | ",
                  y.cells.map((C, p) =>
                    y.hasLineBreak ? C : C + " ".repeat(m[p] - et(C)),
                  ),
                ),
              ),
            ),
  ...
  function Wr(e, t) {
    return mt(e, (r) =>
      typeof r == "string" ? (t ? N(!1, r, /(\\*)`/gu, "$1$1\\`") : rs(r)) : r,
    );
  }
  function rs(e) {
  ...
  function Nu(e) {
    let t = (n) => n.type === "TemplateLiteral",
      r = (n, s) =>
        ...
        s === "value";
    return (
      e.match(t, (n, s) => U(n) && s === "elements", r, ...ss) ||
      e.match(t, r, ...ss)
    );
  }
  function Xu(e) {
  ...
  function Gr({ node: e, parent: t }, r) {
    return (
      ns(e, r) ||
      (kp(t) && ns(t, r)) ||
      (t.type === "ExpressionStatement" && ns(t, r))
    );
  }
  function kp(e) {
    return (
  ...
  async function Ip(e, t, r) {
    let { node: n } = r,
      ...
      i = s.reduce(
        (m, D, y) =>
          y === 0 ? D : m + "@prettier-placeholder-" + u++ + "-id" + D,
        "",
      ),
        ...
        return (
          ...
          (t.callee.type === "MemberExpression" &&
            ((t.callee.object.type === "MemberExpression" &&
              (Ur(t.callee.object.object) || Yu(t.callee.object))) ||
              (t.callee.object.type === "CallExpression" &&
                Ur(t.callee.object.callee))))
        );
      case "Identifier":
        return t.name === "css";
      default:
  ...
  function jp(e) {
    if (wp(e) || Op(e) || _p(e) || Nu(e)) return Ip;
  }
  var Hu = jp;
...
`),
      ...
      let B = null;
      S ? (B = Mp(y)) : (B = await e(D, { parser: "graphql" })),
        B
          ? ((B = Wr(B, !1)),
            !c && A && i.push(""),
            i.push(B),
  ...
  async function $u(e, t, r, n, s) {
    ...
    let a = (S) => `PRETTIER_HTML_PLACEHOLDER_${S}_${i}_IN_JS`,
      o = u.quasis
        .map((S, B, _) =>
          B === _.length - 1 ? S.value.cooked : S.value.cooked + a(B),
        )
        .join(""),
      c = Gt(n, r),
        ...
        for (let J = 0; J < _.length; J++) {
          ...
          if (J % 2 === 0) {
            j &&
              ((j = rs(j)),
              s.__embeddedInHtml &&
                (j = N(!1, j, /<\/(?=script\b)/giu, String.raw`<\/`)),
              B.push(j));
            continue;
          }
          let h = Number(j);
  ...
  var Wp = $u.bind(void 0, "html"),
    Gp = $u.bind(void 0, "angular");
  function Up(e) {
    if (qp(e)) return Wp;
    if (Xu(e)) return Gp;
  }
  ...
  function ii(e) {
    let t = `
`;
    e = N(!1, e.replace(zp, "").replace(Kp, ""), ec, "$1");
    let r = "";
    for (; r !== e; ) (r = e), (e = N(!1, e, Zp, `${t}$1 $2${t}`));
...
`,
  ...
  function ti(e, t) {
    return [...ni, ...(Array.isArray(t) ? t : [t])].map((r) =>
      `@${e} ${r}`.trim(),
    );
  }
  function tc(e) {
...
`);
  ...
  function pi(e) {
    let { shebang: t, text: r, pragmas: n, comments: s } = rc(e),
      u = ui(r),
...
`) +
  ...
  function is(e, t) {
    ...
    if (t.__isInHtmlInterpolation && !t.bracketSpacing && ac(r) && or(e))
      return !0;
    if (sc(r)) return !1;
    ...
    if (r.type === "ObjectExpression") {
      let p =
        (o = e.findAncestor((A) => A.type === "ArrowFunctionExpression")) ==
        null
          ? void 0
          : o.body;
      if (
      ...
      case "ClassExpression":
        if (
          ...
          (r.type === "ArrowFunctionExpression" ||
            ...
            (r.type === "ClassExpression" && w(r.decorators)))
        )
          return !0;
        break;
      ...
      case "TypeAnnotation":
        if (
          e.match(
            ...
            void 0,
            (p, A) =>
              A === "returnType" && p.type === "ArrowFunctionExpression",
          ) &&
          ic(r)
        )
          return !0;
    ...
    switch (r.type) {
      ...
      case "BinaryExpression":
        if (s.type === "UpdateExpression" || (r.operator === "in" && uc(e)))
          return !0;
        ...
        switch (s.type) {
          ...
          case "BinaryExpression": {
            ...
            let T = er(p),
              S = s.operator,
              B = er(S);
            return B > T || (n === "right" && B === T) || (B === T && !nr(S, p))
              ? !0
              : B < T && p === "%"
                ? S === "+" || S === "-"
                : !!yu(S);
      ...
      case "FunctionTypeAnnotation": {
        ...
        if (
          e.match(
            ...
            (A, T) =>
              T === "returnType" && A.type === "ArrowFunctionExpression",
          ) ||
          e.match(
            void 0,
        ...
        return (
          ...
          (n === "extendsType" &&
            ...
            ((m = r.returnType) == null ? void 0 : m.type) ===
              "InferTypeAnnotation" &&
      ...
      case "NGPipeExpression":
        return !(
          ...
          (s.type === "ObjectProperty" &&
            !((C = r.extra) != null && C.parenthesized)) ||
          U(s) ||
          (n === "arguments" && L(s)) ||
  ...
  function ic(e) {
    return tr(
      ...
      (t) =>
        ...
        tr(t, (r) => r.type === "FunctionTypeAnnotation"),
    );
  }
  function ac(e) {
    return se(e);
  ...
  function li(e, t) {
    ...
    return r.type === "FunctionExpression" || r.type === "ClassExpression"
      ? n.type === "ExportDefaultDeclaration" || !is(e, t)
      : !jt(r) || (n.type !== "ExportDefaultDeclaration" && is(e, t))
        ? !1
        : e.call(() => li(e, t), ...Pr(r));
  }
  function oc(e) {
  ...
  function pc(e) {
    return (
      ...
      as(e) || (L(e) && !e.optional && as(e.callee))
    );
  }
  var Be = is;
  function cc(e, t) {
    let r = t - 1;
    (r = Ge(e, r, { backwards: !0 })),
      (r = Ue(e, r, { backwards: !0 })),
      (r = Ge(e, r, { backwards: !0 }));
  ...
  function yc(e, t, r) {
    ...
    if (
      ...
      te(i, a(n), { backwards: !0 })
    ) {
      let m = mi(i, a(n));
      return { doc: Gn([F, m ? F : "", s]), isBlock: o, hasLineSuffix: !0 };
    }
    return !o || (r != null && r.hasLineSuffix)
      ? { doc: [Gn([" ", s]), Ee], isBlock: o, hasLineSuffix: !0 }
      : { doc: [" ", s], isBlock: o, hasLineSuffix: !1 };
  }
  function M(e, t, r = {}) {
    let { node: n } = e;
    if (!w(n == null ? void 0 : n.comments)) return "";
    let { indent: s = !1, marker: u, filter: i = lc } = r,
      a = [];
    if (
      (e.each(({ node: c }) => {
        c.leading || c.trailing || c.marker !== u || !i(c) || a.push(os(e, t));
      }, "comments"),
      a.length === 0)
    )
      return "";
  ...
  function ps(e, t) {
    ...
    return (
      e.each(() => {
        ...
        c ? u.push(mc(e, t)) : m && ((a = yc(e, t, a)), i.push(a.doc));
      }, "comments"),
      { leading: u, trailing: i }
    );
  }
  function ye(e, t, r) {
    let { leading: n, trailing: s } = ps(e, r);
...
\r	`),
  ...
  function Dc(e, t, r) {
    ...
    n.children = n.children.map((h) =>
      kc(h) ? { type: "JSXText", value: " ", raw: " " } : h,
    );
    let i = n.children.some(X),
      a =
        n.children.filter((h) => h.type === "JSXExpressionContainer").length >
        1,
      ...
      y = m ? " " : b([D, E], " "),
      C =
        ((J = (_ = n.openingElement) == null ? void 0 : _.name) == null
          ? void 0
          : J.name) === "fbt",
      p = fc(e, t, r, y, C),
    ...
    for (; p.length > 0 && ys(O(!1, p, -1)); ) p.pop();
    for (; p.length > 1 && ys(p[0]) && ys(p[1]); ) p.shift(), p.shift();
    let T = [];
        ...
        if (i.type === "JSXText") {
          ...
          if (pr(i)) {
            ...
            c[0] === "" &&
              (u.push(""),
              c.shift(),
              /\n/u.test(c[0]) ? u.push(fi(s, c[1], i, a)) : u.push(n),
              c.shift());
            let m;
            if (
              (O(!1, c, -1) === "" && (c.pop(), (m = c.pop())), c.length === 0)
            )
              return;
            for (let [D, y] of c.entries()) D % 2 === 1 ? u.push(x) : u.push(y);
            m !== void 0
              ? /\n/u.test(m)
                ? u.push(fi(s, O(!1, u, -1), i, a))
                : u.push(n)
              : u.push(Di(s, O(!1, u, -1), i, a));
          } else
            /\n/u.test(o)
              ? o.match(/\n/gu).length > 1 && u.push("", F)
              : u.push("", n);
        } else {
          let o = r();
          if ((u.push(o), a && pr(a))) {
  ...
  function Cc(e, t, r) {
    ...
    if ((s.push(r("name")), n.value)) {
      ...
      if (Q(n.value)) {
        ...
        (a = o === '"' ? N(!1, a, '"', "&quot;") : N(!1, a, "'", "&apos;")),
          (u = e.call(() => ye(e, Ie(o + a + o), t), "value"));
      } else u = r("value");
      s.push("=", u);
    }
    return s;
...
`),
  ...
  function hc(e, t, r) {
    ...
    let u = r("name");
    return (
      d(n.name, g.Leading | g.Line)
        ? s.push(f([F, u]), F)
        : d(n.name, g.Leading | g.Block)
          ? s.push(" ", u)
          : s.push(u),
      s.push(">"),
      s
  ...
  function bc(e, t, r) {
    ...
    return [
      ...
      e.call(
        ({ node: s }) => {
          let u = ["...", r()];
          return !d(s) || !Qn(e) ? u : [f([E, ye(e, u, t)]), E];
        },
  ...
  function pr(e) {
    return (
      e.type === "JSXText" &&
      (Nr.hasNonWhitespaceCharacter(fe(e)) || !/\n/u.test(fe(e)))
    );
  }
  function kc(e) {
    return (
  ...
  function Yr(e, t, r) {
    ...
    let { node: n, parent: s, grandparent: u, key: i } = e,
      ...
      o =
        n.operator === "|>" &&
        ((J = e.root.extra) == null ? void 0 : J.__isUsingHackPipeline),
      c = Ds(e, r, t, !1, a);
    if (a) return c;
    if (o) return l(c);
    if (
    ...
    let C = X(n.right),
      p = c.findIndex(
        (j) => typeof j != "string" && !Array.isArray(j) && j.type === le,
      ),
      A = c.slice(0, p === -1 ? 1 : p + 1),
      T = c.slice(A.length, C ? -1 : void 0),
      S = Symbol("logicalChain-" + ++Lc),
      B = l([...A, f(T)], { id: S });
    if (!C) return B;
    let _ = O(!1, c, -1);
  ...
  function Ds(e, t, r, n, s) {
    ...
    if (!De(u)) return [l(t())];
    let i = [];
    nr(u.operator, u.left.operator)
      ? (i = e.call((T) => Ds(T, t, r, !0, s), "left"))
      : i.push(l(t("left")));
    let a = Ut(u),
      o =
        (u.operator === "|>" || u.type === "NGPipeExpression" || wc(e, r)) &&
        !Oe(r.originalText, u.right),
    ...
    if (a) D = [c, " ", t("right"), m];
      ...
      let S =
        c === "|>" &&
        ((A = e.root.extra) == null ? void 0 : A.__isUsingHackPipeline)
          ? e.call((B) => Ds(B, t, r, !0, s), "right")
          : t("right");
      D = [o ? x : "", c, o ? " " : x, S, m];
    }
    let { parent: y } = e,
  ...
  function wc(e, t) {
    return (
      ...
      Ci(e.node) &&
      !e.hasAncestor((r) => !Ci(r) && r.type !== "JsExpressionRoot")
    );
  }
  function Ti(e, t, r) {
    let { node: n } = e;
    if (n.type.startsWith("NG"))
      switch (n.type) {
        case "NGRoot":
          return [
            r("node"),
            d(n.node) ? " //" + ct(n.node)[0].value.trimEnd() : "",
          ];
        case "NGPipeExpression":
          return Yr(e, t, r);
  ...
  function xi(e, t, r) {
    ...
    let i =
      n.type === "ClassExpression" || n.type === "ClassDeclaration" || hi(n, t);
    return [
  ...
  function jc(e, t, r) {
    ...
    if (Mc(s)) {
      ...
      let C;
      try {
        C = r(Jn(n, 0), { expandFirstArg: !0 });
      } catch (p) {
        if (p instanceof Dt) return m();
        throw p;
      }
      return ne(C)
        ? [Ee, ze([["(", l(C, { shouldBreak: !0 }), ", ", ...y, ")"], m()])]
        : ze([
            ["(", C, ", ", ...y, ")"],
            ["(", l(C, { shouldBreak: !0 }), ", ", ...y, ")"],
            m(),
    ...
    if (vc(s, a, t)) {
      ...
      let C;
      try {
        C = r(Jn(n, -1), { expandLastArg: !0 });
      } catch (p) {
        if (p instanceof Dt) return m();
        throw p;
      }
      return ne(C)
        ? [Ee, ze([["(", ...y, l(C, { shouldBreak: !0 }), ")"], m()])]
        : ze([
            ["(", ...y, C, ")"],
            ["(", ...y, l(C, { shouldBreak: !0 }), ")"],
            m(),
  ...
  function cr(e, t = !1) {
    return (
      (se(e) && (e.properties.length > 0 || d(e))) ||
      (U(e) && (e.elements.length > 0 || d(e))) ||
      (e.type === "TSTypeAssertion" && cr(e.expression)) ||
      (Te(e) && cr(e.expression)) ||
      e.type === "FunctionExpression" ||
      (e.type === "ArrowFunctionExpression" &&
        ...
        (e.body.type === "BlockStatement" ||
          (e.body.type === "ArrowFunctionExpression" && cr(e.body, !0)) ||
          se(e.body) ||
          U(e.body) ||
  ...
  function Mc(e) {
    ...
    let [t, r] = e;
    return t.type === "ModuleExpression" && qc(r)
      ? !0
      : !d(t) &&
  ...
  function Bi(e) {
    ...
    return lt(e) && oe(e).length > 1
      ? !1
      : De(e)
        ? be(e.left, 1) && be(e.right, 1)
        : Mn(e) || be(e);
  }
  function Rc(e) {
    return e.length === 2
  ...
  function Jc(e) {
    return (
      ...
      (e.body.some((t) => t.type !== "EmptyStatement") || d(e, g.Dangling))
    );
  }
  function qc(e) {
    return (
  ...
  function bi(e, t, r) {
    ...
    let n = r("object"),
      ...
      a = e.findAncestor(
        (m) =>
          !(m.type === "ChainExpression" || m.type === "TSNonNullExpression"),
      ),
      o =
        (i &&
        ...
        ((a.type === "AssignmentExpression" ||
          ...
          (Wc(u.object) || ((c = n.label) == null ? void 0 : c.memberChain)));
  ...
  function Pi(e, t, r) {
    if (e.node.type === "ChainExpression")
      return e.call(() => Pi(e, t, r), "expression");
    let { parent: n } = e,
      ...
      if (L(G) && (Ft(G.callee) || L(G.callee))) {
        ...
        Ft(G)
          ? (u.unshift({
              node: G,
              needsParens: Be(I, t),
              printed: ye(I, q(G) ? Fs(I, t, r) : Hr(I, t, r), t),
            }),
            I.call((ee) => a(ee), "object"))
          : G.type === "TSNonNullExpression"
            ? (u.unshift({ node: G, printed: ye(I, "!", t) }),
              I.call((ee) => a(ee), "expression"))
            : u.unshift({ node: G, printed: r() });
    }
    let { node: o } = e;
    u.unshift({ node: o, printed: [V(e), Qe(e, t, r), lr(e, t, r)] }),
      o.callee && e.call((I) => a(I), "callee");
    let c = [],
      m = [u[0]],
      D = 1;
    for (
      ...
      (u[D].node.type === "TSNonNullExpression" ||
        L(u[D].node) ||
        (q(u[D].node) && u[D].node.computed && Ce(u[D].node.property)));
      ++D
    )
      m.push(u[D]);
    if (!L(u[0].node))
      for (; D + 1 < u.length && Ft(u[D].node) && Ft(u[D + 1].node); ++D)
        m.push(u[D]);
    c.push(m), (m = []);
    let y = !1;
    for (; D < u.length; ++D) {
      ...
      (L(u[D].node) || u[D].node.type === "ImportExpression") && (y = !0),
        m.push(u[D]),
        d(u[D].node, g.Trailing) && (c.push(m), (m = []), (y = !1));
    }
    m.length > 0 && c.push(m);
    function C(I) {
    ...
    function A(I) {
      ...
      if (I[0].length === 1) {
        let xt = I[0][0].node;
        return (
          xt.type === "ThisExpression" ||
          (xt.type === "Identifier" && (C(xt.name) || (s && p(xt.name)) || G))
        );
      }
      let ee = O(!1, I[0], -1).node;
      return (
        q(ee) && ee.property.type === "Identifier" && (C(ee.property.name) || G)
      );
    }
    ...
    let _ = c.map(S),
      ...
      h = c.flat(),
      W =
        h.slice(1, -1).some((I) => d(I.node, g.Leading)) ||
        h.slice(0, -1).some((I) => d(I.node, g.Trailing)) ||
        (c[j] && d(c[j][0].node, g.Leading));
    if (
      c.length <= j &&
      !W &&
      !c.some((I) => O(!1, I, -1).hasTrailingEmptyLine)
    )
      return Or(e) ? J : l(J);
    ...
    function It() {
      let I = O(!1, O(!1, c, -1), -1).node,
        G = O(!1, _, -1);
      return (
        L(I) && ne(G) && Z.slice(0, -1).some((ee) => ee.arguments.some(_t))
      );
    }
    let $t;
    return (
      W ||
      (Z.length > 2 && Z.some((I) => !I.arguments.every((G) => be(G)))) ||
      _.slice(0, -1).some(ne) ||
      It()
        ? ($t = l(ue))
        : ($t = [ne(J) || H ? Ee : "", ze([J, ue])]),
  ...
  function Uc(e, t, r, n, s) {
    ...
    if (
      ...
      return a
        ? i.type === "ArrowFunctionExpression" &&
          ...
          : "chain-tail"
        : "chain";
    if ((!a && $r(i.right)) || Oe(t.originalText, i))
    ...
    let m = Bu(n);
    if (Xc(u) || $c(u) || (Cs(u) && m)) return "break-lhs";
    let D = zc(u, n, t);
    return e.call(() => Nc(e, t, r, D), s)
  ...
  var Hc = v(["TSTypeAliasDeclaration", "TypeAlias"]);
  function Vc(e) {
    var t;
  ...
  function $c(e) {
    ...
    return (
      w(r) &&
      r.length > 1 &&
      r.some((n) => w(Li(n)) || n.type === "TSConditionalType")
    );
  }
  function Cs(e) {
    var t;
  ...
  function Li(e) {
    var t;
    if (Kc(e))
      return (t = e.typeArguments ?? e.typeParameters) == null
        ? void 0
        : t.params;
  }
  function ji(e, t, r, n = !1) {
    ...
    if (L(s)) {
      ...
      let o = oe(s);
      return !(o.length === 0 || (o.length === 1 && rr(o[0], t))) || Qc(s, r)
        ? !1
        : e.call(u, "callee");
    }
    return q(s)
  ...
  function zc(e, t, r) {
    return Ae(e)
      ? ((t = Wt(t)), typeof t == "string" && et(t) < r.tabWidth + 3)
      : !1;
  }
  function Qc(e, t) {
    let r = Zc(e);
    ...
    if (
      (fu(e, (p, A) => {
        ...
        T && u.rest && D.push("..."),
          ...
          !T &&
            (D.push(","),
            c || m ? D.push(" ") : pe(i[A], r) ? D.push(F, F) : D.push(x));
      }),
      n && !rl(e))
    ) {
  ...
  function ul(e) {
    ...
    let r = t.find((n) => sl(n));
    return r ? t.every((n) => n === r || nl(n)) : !1;
  }
  function Ts(e) {
    return Mt(e) || we(e) ? !0 : Ne(e) ? ul(e) : !1;
  }
  function Mi(e, t, r) {
    let n = t.semi ? ";" : "",
      { node: s } = e,
  ...
  function Zr(e, t, r) {
    ...
    return (
      n.type === "FunctionTypeAnnotation"
        ? i.push(il(e) ? " => " : ": ", r("returnType"))
        : i.push(Y(e, r, n.returnType ? "returnType" : "typeAnnotation")),
      ot(n, i) && (u = l(u)),
      s.push(u, i),
      l(s)
    );
  ...
  function Y(e, t, r = "typeAnnotation") {
    ...
    if (n.type === "TSTypeAnnotation" || n.type === "TypeAnnotation") {
      let u = e.call(Ri, r);
      (u === "=>" || (u === ":" && d(n, g.Leading))) && (s = !0), al.add(n);
    }
    return s ? [" ", t(r)] : t(r);
  }
  var Ri = (e) =>
  ...
  function V(e) {
    ...
    return !t.optional || (t.type === "Identifier" && t === e.parent.key)
      ? ""
      : L(t) || (q(t) && t.computed) || t.type === "OptionalIndexedAccessType"
        ? "?."
        : "?";
  }
  function pn(e) {
  ...
  function $(e) {
    let { node: t } = e;
    return t.declare ||
      (ol.has(t.type) && e.parent.type !== "DeclareExportDeclaration")
      ? "declare "
      : "";
  }
  var pl = new Set([
  ...
  function cl(e, t, r, n) {
    let { node: s } = e,
      u = s.inexact ? "..." : "";
    return d(s, g.Dangling)
      ? l([r, u, M(e, t, { indent: !0 }), E, n])
      : [r, u, n];
  }
  function Yt(e, t, r) {
    let { node: n } = e,
      ...
      a =
        n.type === "TupleTypeAnnotation" && n.types
          ...
          : n.type === "TSTupleType" || n.type === "TupleTypeAnnotation"
            ...
            : "elements",
      o = n[a];
    if (o.length === 0) s.push(cl(e, t, u, i));
    else {
      let c = O(!1, o, -1),
      ...
      s.push(
        l(
          [
            ...
            f([
              E,
              p ? ml(e, t, r, A) : [ll(e, t, a, n.inexact, r), A],
              M(e, t),
            ]),
            E,
            i,
  ...
  function Es(e, t) {
    return (
      ...
      e.elements.every(
        (r) =>
          r &&
          (Ce(r) || (vn(r) && !d(r.argument))) &&
          !d(
            r,
            g.Trailing | g.Line,
            (n) => !te(t.originalText, R(n), { backwards: !0 }),
          ),
      )
    );
  }
  ...
  function ml(e, t, r, n) {
    ...
    return (
      e.each(({ isLast: u, next: i }) => {
        s.push([r(), u ? n : ","]),
          u || s.push(Ji(e, t) ? [F, F] : d(i, g.Leading | g.Line) ? F : x);
      }, "elements"),
      qt(s)
    );
  }
  ...
  function Gi(e, t) {
    return t.parser === "json" ||
      t.parser === "jsonc" ||
      !Q(e.key) ||
      tt(fe(e.key), t).slice(1, -1) !== e.key.value
      ? !1
      : !!(
          (Wi(e.key.value) &&
            !(
  ...
  function El(e, t) {
    ...
    return (
      (r.type === "Identifier" ||
        (Ce(r) &&
          Ui(Ze(fe(r))) &&
          String(r.value) === Ze(fe(r)) &&
          !(t.parser === "typescript" || t.parser === "babel-ts"))) &&
      (t.parser === "json" ||
        t.parser === "jsonc" ||
        (t.quoteProps === "consistent" && mn.get(e.parent)))
    );
  }
  function Et(e, t, r) {
    let { node: n } = e;
    ...
    return Gi(n, t) &&
      (t.quoteProps === "as-needed" ||
        (t.quoteProps === "consistent" && !mn.get(s)))
      ? e.call(
          (i) => ye(i, /^\d/u.test(u.value) ? Ze(u.value) : u.value, t),
          "key",
        )
      : r("key");
  }
  ...
  function Dn(e, t, r, n) {
    ...
    let i = [
      ...
      c = ot(s, o);
    return (
      i.push(Qe(e, r, t), l([c ? l(a) : a, o]), s.body ? " " : "", t("body")),
  ...
  function Al(e, t) {
    if (
      Oe(e.originalText, t) ||
      (d(t, g.Leading, (r) => de(e.originalText, R(r), k(r))) && !X(t))
    )
      return !0;
    if (jt(t)) {
      let r = t,
    ...
    return (
      xs.has(e) ||
        xs.set(
          e,
          e.type === "ConditionalExpression" &&
            !ie(e, (t) => t.type === "ObjectExpression"),
        ),
      xs.get(e)
    );
  }
  ...
  function $i(e, t, r, n = {}) {
    ...
    (function T() {
      ...
      if (s.length === 0) s.push(B);
        ...
        let { leading: _, trailing: J } = ps(e, t);
        s.push([_, B]), i.unshift(J);
      }
      o &&
        (a ||
          (a =
            (S.returnType && K(S).length > 0) ||
            S.typeParameters ||
            K(S).some((_) => _.type !== "Identifier"))),
        !o || S.body.type !== "ArrowFunctionExpression"
          ? ((u = r("body", n)), (c = S.body))
          : e.call(T, "body");
    })();
    let m = !Oe(t.originalText, c) && (Vi(c) || dl(c, u, t) || (!a && Hi(c))),
      D = e.key === "callee" && lt(e.parent),
      y = Symbol("arrow-chain"),
      C = xl(e, n, { signatureDocs: s, shouldBreak: a }),
      p,
      A = !1;
    return (
      o &&
        ...
        ((A = !0),
        (p = n.assignmentLayout === "chain-tail-arrow-chain" || (D && !m))),
      (u = hl(e, t, n, {
        bodyDoc: u,
        bodyComments: i,
        functionBody: c,
      ...
      l([
        l(A ? f([E, C]) : C, { shouldBreak: p, id: y }),
        " =>",
        o ? At(u, { groupId: y }) : l(u),
        o && D ? b(E, "", { groupId: y }) : "",
      ])
    );
  }
  ...
  function dl(e, t, r) {
    ...
    return (
      ...
      (((n = t.label) == null ? void 0 : n.hug) !== !1 &&
        (((s = t.label) == null ? void 0 : s.embed) || Lr(e, r.originalText)))
    );
  }
  function xl(e, t, { signatureDocs: r, shouldBreak: n }) {
    ...
    return (u !== "callee" && lt(s)) || De(s)
      ? l([r[0], " =>", f([x, P([" =>", x], r.slice(1))])], { shouldBreak: n })
    ...
    return (
      e.each(({ node: a }) => {
        a.type !== "EmptyStatement" &&
          (u.push(r()), a !== i && (u.push(F), pe(a, t) && u.push(F)));
      }, n),
      u
    );
  }
  function Fn(e, t, r) {
    ...
    if (
      s.type === "Program" &&
      (u == null ? void 0 : u.type) !== "ModuleExpression"
    )
      return n ? [n, F] : "";
    let i = [];
  ...
  function Sl(e, t, r) {
    ...
    return (
      s &&
        (a.push(yr(e, t, r, "directives")),
        (u || i) && (a.push(F), pe(O(!1, n.directives, -1), t) && a.push(F))),
  ...
  function Pt(e, t, r, n) {
    ...
    if (
      ...
      (!i &&
        (u ||
          (s[n].length === 1 &&
            (s[n][0].type === "NullableTypeAnnotation" || Ts(s[n][0])))))
    )
      return ["<", P(", ", e.map(r, n)), kl(e, t), ">"];
    let o =
      s.type === "TSTypeParameterInstantiation"
        ? ""
        : Pl(e, t, n)
  ...
  function An(e, t, r) {
    ...
    if (s.type === "TSMappedType")
      return (
        s.readonly && u.push(hs(s.readonly, "readonly"), " "),
        u.push("[", i),
    ...
    if (
      ...
      u.push(i),
      n.bound &&
        (n.usesExtendsBound && u.push(" extends "), u.push(Y(e, r, "bound"))),
      n.constraint)
    ) {
  ...
  function Tn(e, t, r) {
    ...
    } else a.push(gs(e, t, r, "extends"));
    if ((a.push(gs(e, t, r, "mixins"), gs(e, t, r, "implements")), u)) {
      let o;
      ta(n) ? (o = [...i, f(a)]) : (o = f([...i, a])),
        s.push(l(o, { id: ea(n) }));
    } else s.push(...i, ...a);
  ...
  function ta(e) {
    return (
      e.typeParameters && !d(e.typeParameters, g.Trailing | g.Line) && !Il(e)
    );
  }
  function gs(e, t, r, n) {
    let { node: s } = e;
  ...
  function dn(e, t, r) {
    let { node: n } = e,
      s = [];
    return (
      w(n.decorators) && s.push(fs(e, t, r)),
      s.push(Xt(n)),
  ...
  function xn(e, t, r) {
    ...
    w(n.decorators) && s.push(fs(e, t, r)),
      ...
      (n.type === "ClassAccessorProperty" ||
        ...
        s.push("accessor "),
      s.push(Et(e, t, r), V(e), pn(e), Y(e, r));
    let i =
  ...
  function ra(e, t, r) {
    ...
    return (
      e.each(({ node: u, next: i, isLast: a }) => {
        s.push(r()),
          !t.semi && Zi(u) && wl(u, i) && s.push(";"),
          a || (s.push(F), pe(u, t) && s.push(F));
      }, "body"),
      d(n, g.Dangling) && s.push(M(e, t)),
      [
        w(n.body) ? Ss(e.parent) : "",
        "{",
        s.length > 0 ? [f([F, s]), F] : "",
        "}",
      ]
  ...
  function na(e, t) {
    if (t.semi || Bs(e, t) || Ps(e, t)) return !1;
    let { node: r, key: n, parent: s } = e;
    return !!(
  ...
  function ua(e, t, r) {
    ...
    return (
      Ps(e, t)
        ? bs(e.node.expression) && n.push(";")
        : Bs(e, t) || (t.semi && n.push(";")),
      n
    );
  }
  function ia(e, t, r) {
  ...
  function gn(e, t, r) {
    ...
    return (
      d(n, g.Dangling) && (s.push(" ", M(e, t)), wr(n) && s.push(F)),
      u
  ...
  function vl(e, t) {
    return t.semi && (!e.declaration || (la(e) && !jl(e.declaration)))
      ? ";"
      : "";
  }
  function ks(e, t = !0) {
  ...
  function Is(e, t) {
    return ks(e.importKind, t);
  }
  function Ml(e) {
    return ks(e.exportKind);
  }
  function ma(e, t, r) {
    let { node: n } = e;
    if (!n.source) return "";
  ...
  function Da(e, t) {
    return e.type !== "ImportDeclaration" ||
      ...
      e.importKind === "type"
      ? !0
      : fr(t, R(e), R(e.source)).trimEnd().endsWith("from");
  }
  function Rl(e, t) {
    var n, s;
    ...
    let r = fr(
      t,
      k(e.source),
      (s = e.attributes) != null && s[0] ? R(e.attributes[0]) : k(e),
    ).trimStart();
    return r.startsWith("assert")
      ? "assert"
      : r.startsWith("with") || w(e.attributes)
        ? "with"
        : void 0;
  }
  function fa(e, t, r) {
  ...
  function Ea(e, t, r) {
    ...
    return (
      ...
      c && !Jl(n) && (D = r(a)),
      [
        ks(s === "ImportSpecifier" ? n.importKind : n.exportKind, !1),
        m,
        m && D ? " as " : "",
        D,
      ]
  ...
  function dt(e, t, r) {
    ...
    let o = a.flatMap((h) =>
      e.map(({ node: W }) => ({ node: W, printed: r(), loc: R(W) }), h),
    );
    ...
    let { parent: c, key: m } = e,
      D =
        u &&
        m === "body" &&
        (c.type === "InterfaceDeclaration" ||
          c.type === "DeclareInterface" ||
          c.type === "DeclareClass"),
      y =
        s.type === "TSInterfaceBody" ||
        i ||
        ...
        (s.type === "ObjectPattern" &&
          ...
          c.type !== "ObjectMethod" &&
          c.type !== "ClassMethod" &&
          c.type !== "ClassPrivateMethod" &&
          c.type !== "AssignmentPattern" &&
          c.type !== "CatchClause" &&
          s.properties.some(
            (h) =>
              h.value &&
              (h.value.type === "ObjectPattern" ||
                h.value.type === "ArrayPattern"),
          )) ||
        (s.type !== "ObjectPattern" &&
          o.length > 0 &&
          de(t.originalText, R(s), o[0].loc)),
      C = D
        ? ";"
      ...
      S = o.map((h) => {
        ...
        return (
          (T = [C, x]),
          (h.node.type === "TSPropertySignature" ||
            h.node.type === "TSMethodSignature" ||
            h.node.type === "TSConstructSignatureDeclaration" ||
            h.node.type === "TSCallSignatureDeclaration") &&
            d(h.node, g.PrettierIgnore) &&
            T.shift(),
          pe(h.node, t) && T.push(F),
          W
        );
      });
    if (s.inexact || s.hasUnknownMembers) {
      ...
      if (d(s, g.Dangling)) {
        ...
        h = [
          M(e, t),
          W || te(t.originalText, k(O(!1, ct(s), -1))) ? F : x,
          "...",
        ];
      } else h = ["..."];
      S.push([...T, ...h]);
        ...
        (B &&
          (B.type === "RestElement" ||
            ((B.type === "TSPropertySignature" ||
              B.type === "TSCallSignatureDeclaration" ||
              B.type === "TSMethodSignature" ||
              B.type === "TSConstructSignatureDeclaration") &&
              d(B, g.PrettierIgnore))))
      ),
      J;
    if (S.length === 0) {
    ...
    return e.match((h) => h.type === "ObjectPattern" && !w(h.decorators), Ls) ||
      (we(s) &&
        (e.match(
          void 0,
          ...
          e.match(
            void 0,
            (h, W) => h.type === "FunctionTypeParam" && W === "typeAnnotation",
            Ls,
          ))) ||
      (!y &&
        e.match(
    ...
    if (s && (X(n[a[0]]) || X(o) || X(c) || ql(_))) {
      ...
      m.push(
        y.type !== n.type || y[i] === n || C
          ...
          : t.useTabs
            ? Mr(f(ue))
            : he(Math.max(0, t.tabWidth - 2), ue),
      );
    }
    let J = [u, i, ...a].some((H) =>
        d(n[H], (ue) => re(ue) && de(t.originalText, R(ue), k(ue))),
      ),
      j = (H) => (y === B ? l(H, { shouldBreak: J }) : J ? [H, Ee] : H),
      h =
        !D &&
        (q(y) || (y.type === "NGPipeExpression" && y.left === n)) &&
        !y.computed,
      W = Ul(e),
      Fe = j([Wl(e, t, r), p ? m : f(m), s && h && !W ? E : ""]);
    return C || W ? l([f([E, Fe]), E]) : Fe;
  }
  function Nl(e, t) {
    return (
      (q(t) || (t.type === "NGPipeExpression" && t.left === e)) && !t.computed
    );
  }
  function Xl(e, t, r, n) {
    return [...e.map((u) => ct(u)), ct(t), ct(r)]
      .flat()
      .some((u) => re(u) && de(n.originalText, R(u), k(u)));
  }
  var Yl = new Map([
    ["AssignmentExpression", "right"],
    ["VariableDeclarator", "init"],
  ...
  function Hl(e) {
    ...
    return n === t ? !1 : r[Yl.get(r.type)] === n;
  }
  var ws = (e) => [b("("), f([E, e]), E, b(")")];
  function Vt(e, t, r, n) {
    if (!t.experimentalTernaries) return Fa(e, t, r);
    let { node: s } = e,
      u = s.type === "ConditionalExpression",
      i =
        s.type === "TSConditionalType" ||
        s.type === "ConditionalTypeAnnotation",
    ...
    let Fe = j || C,
      ...
      Z =
        u &&
        Fe.type === "JSXExpressionContainer" &&
      ...
      qe =
        ...
        (Z
          ? m.type === "NullLiteral" ||
            (m.type === "Literal" && m.value === null)
          : rr(m, t) && Rn(s.test, 3)),
      xt = _ || T || (i && !p) || (p && u && Rn(s.test, 1)) || qe,
      js = [];
    !S &&
      d(m, g.Dangling) &&
      e.call((We) => {
    ...
    let vs = Symbol("test"),
      ...
      Ra = u
        ? [ws(r("test")), s.test.type === "ConditionalExpression" ? Ee : ""]
        : [
            r("checkType"),
            " ",
            "extends",
      ...
      qa = xt
        ...
        : [Ms, Cr],
      kn = r(o),
      Rs = qe ? b(kn, Mr(ws(kn)), { groupId: Fr }) : kn,
      zt = [
        qa,
        Kt.length > 0
          ? [f([F, Kt]), F]
  ...
  function Ca(e, t, r, n) {
    ...
    switch (s.type) {
      ...
      case "ChainExpression":
        return r("expression");
      case "ParenthesizedExpression":
        return !d(s.expression) && (se(s.expression) || U(s.expression))
          ? ["(", r("expression"), ")"]
      ...
      case "BindExpression":
        return (
          s.object && i.push(r("object")), i.push(l(f([E, Hr(e, t, r)]))), i
        );
      case "Identifier":
        ...
        if ((i.push("await"), s.argument)) {
          ...
          if ((L(a) && a.callee === s) || (q(a) && a.object === s)) {
            ...
            let o = e.findAncestor(
              (c) =>
                c.type === "AwaitExpression" || c.type === "BlockStatement",
            );
            if (
      ...
      case "IfStatement": {
        ...
        if ((i.push(o), s.alternate)) {
          ...
          i.push(m ? " " : F),
            d(s, g.Dangling) && i.push(M(e, t), c ? F : " "),
            i.push(
              "else",
              l(
                ft(
        ...
        return !s.init && !s.test && !s.update
          ...
          : [
              ...
              l([
                "for (",
                l([
                  f([E, r("init"), ";", x, r("test"), ";", x, r("update")]),
                  E,
                ]),
                ")",
                a,
      ...
      case "CatchClause":
        if (s.param) {
          let a = d(
              ...
              (c) =>
                !re(c) ||
                (c.leading && te(t.originalText, k(c))) ||
                (c.trailing && te(t.originalText, R(c), { backwards: !0 })),
            ),
            o = r("param");
          return [
            "catch ",
  ...
  function Sn(e, t, r) {
    ...
    return (u === "callee" && L(n)) || (u === "object" && q(n))
      ? l([f([E, ...i]), E])
      : i;
  }
  function Aa(e, t, r) {
  ...
  function Vl(e, t, r) {
    ...
    return (
      Kl(e, (i, a) => {
        ...
        o && n.rest && u.push("..."),
          u.push(t()),
          !o && (u.push(","), pe(s[a], r) ? u.push(F, F) : u.push(x));
      }),
      ["(", f([E, ...u]), b(ae(r, "all") && !$l(n, s) ? "," : ""), E, ")"]
    );
  }
  function $l(e, t) {
    var r;
    return (
      e.rest || ((r = O(!1, t, -1)) == null ? void 0 : r.type) === "RestElement"
    );
  }
  function Kl(e, t) {
    let { node: r } = e,
  ...
  function Pn(e, t, r) {
    ...
    return (
      w(n.extends) &&
        i.push(
          a ? b(" ", x, { groupId: Dr(n.typeParameters) }) : x,
          "extends ",
          (n.extends.length === 1 ? mu : f)(P([",", x], e.map(r, "extends"))),
        ),
      d(n.id, g.Trailing) || w(n.extends)
        ? a
          ? s.push(l([...u, f(i)]))
          : s.push(l(f([...u, ...i])))
        : s.push(...u, ...i),
  ...
  function ka(e, t, r) {
    ...
    switch (n.type) {
      ...
      case "TSInstantiationExpression":
        return [
          r("expression"),
          r(n.typeArguments ? "typeArguments" : "typeParameters"),
        ];
      ...
      case "TSModuleDeclaration": {
        ...
        if (o) u.push(".");
          ...
          let D =
            n.kind ??
            (Q(n.id) || fr(t, R(n), R(n.id)).trim().endsWith("module")
              ? "module"
              : "namespace");
          u.push(D, " ");
        }
  ...
  var kt = "JavaScript",
    ...
    va = um;
  var im = { estree: Os, "estree-json": _s },
    am = [...Us, ...La];
  return Xa(om);
});

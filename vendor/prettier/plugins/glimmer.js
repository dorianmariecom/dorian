(function (f) {
  ...
  var Gt = (t, e) => {
      for (var r in e) zt(t, r, { get: e[r], enumerable: !0 });
    },
    is = (t, e, r, n) => {
  ...
  var as = (t) => is(zt({}, "__esModule", { value: !0 }), t);
  var Mr = (t, e, r) => e.has(t) || Fr("Cannot " + r);
  var $ = (t, e, r) => (
      Mr(t, e, "read from private field"), r ? r.call(t) : e.get(t)
    ),
    Yt = (t, e, r) =>
      e.has(t)
        ...
        : e instanceof WeakSet
          ...
          : e.set(t, r),
    Kt = (t, e, r, n) => (
      Mr(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r
    );
  var ba = {};
  Gt(ba, { languages: () => Sn, parsers: () => Rr, printers: () => ga });
  var os = (t, e, r, n) => {
      if (!(t && e == null))
        return e.replaceAll
          ? e.replaceAll(r, n)
...
Expected it to be ${n}.`;
  ...
  function Jt(t, e = "", r = {}) {
    return (
      be(t),
      e !== "" && be(e),
      { type: Be, breakContents: t, flatContents: e, groupId: r.groupId }
    );
  }
  var Gr = { type: Ie };
  var ps = { type: ee, hard: !0 },
    fs = { type: ee, hard: !0, literal: !0 },
    D = { type: ee },
    Y = { type: ee, soft: !0 },
    ye = [ps, Gr],
    Yr = [fs, Gr];
...
`,
  ...
  function Qr(t, e) {
    ...
    t.type === "ElementNode" &&
      ...
      delete e.params,
      delete e.path),
      t.type === "Block" && (delete e.blockParamNodes, delete e.params),
      t.type === "AttrNode" &&
        t.name.toLowerCase() === "class" &&
        delete e.value,
      t.type === "PathExpression" && (e.head = t.head.original);
  }
  ...
  var Ss = 10;
  for (let t = 0; t <= Ss; t++) et();
  function rr(t) {
    return et(t);
  }
  function ws(t, e = "type") {
    rr(t);
    function r(n) {
      let s = n[e],
        i = t[s];
  ...
  function rn(t) {
    return (
      (t == null ? void 0 : t.type) === "MustacheCommentStatement" &&
      typeof t.value == "string" &&
      t.value.trim() === "prettier-ignore"
    );
  }
  function sn(t) {
    return (
      rn(t.node) ||
      (t.isInArray &&
        (t.key === "children" || t.key === "body" || t.key === "parts") &&
        rn(t.siblings[t.index - 2]))
    );
  }
  var fn = 2;
  function vs(t, e, r) {
    ...
    switch (n.type) {
      ...
      case "ElementNode": {
        let g = q(Ps(t, r)),
          T =
            e.htmlWhitespaceSensitivity === "ignore" &&
            ((s = t.next) == null ? void 0 : s.type) === "ElementNode"
              ? Y
              : "";
        if (nr(n)) return [g, T];
        let x = ["</", n.tag, ">"];
        return n.children.length === 0
          ? [g, R(x), T]
          : e.htmlWhitespaceSensitivity === "ignore"
            ? [g, R(an(t, e, r)), ye, R(x), T]
            : [g, R(q(an(t, e, r))), R(x), T];
      }
      case "BlockStatement":
        return Os(t)
          ? [Bs(t, r), cn(t, r, e), un(t, r, e)]
          : [_s(t, r), q([cn(t, r, e), un(t, r, e), Is(t, r, e)])];
      ...
      case "AttrNode": {
        ...
        let v = x
            ? gt(T.chars, e.singleQuote)
            : T.type === "ConcatStatement"
              ? gt(
                  T.parts
                    .map((H) => (H.type === "TextNode" ? H.chars : ""))
                    .join(""),
                  e.singleQuote,
                )
              : "",
      ...
      case "TextNode": {
        ...
        if (T) {
          if (T === "class") {
            let J = g.trim().split(/\s+/u).join(" "),
              ...
              V = !1;
            return (
              t.parent.type === "ConcatStatement" &&
                (((i = t.previous) == null ? void 0 : i.type) ===
                  "MustacheStatement" &&
                  /^\s/u.test(g) &&
                  (re = !0),
                ((a = t.next) == null ? void 0 : a.type) ===
                  "MustacheStatement" &&
                  /\s$/u.test(g) &&
                  J !== "" &&
                  (V = !0)),
        ...
        if (e.htmlWhitespaceSensitivity !== "ignore") {
          ...
          if (x) {
            ...
            let _ = [D],
              se = Re(g);
            return se && (_ = rt(se)), v && (_ = _.map((ut) => Qt(ut))), _;
          }
          ...
          if (U) {
            if (!J) {
              ne = [D];
              let _ = Re(U);
              _ && (ne = rt(_)), v && (ne = ne.map((se) => Qt(se)));
            }
            g = g.slice(0, -U.length);
          }
          return [...Pe, Xt(hn(g)), ...ne];
        }
        let M = Re(g),
          H = Hs(g),
          X = Vs(g);
        if (
          ...
          x &&
          (t.parent.type === "Block" ||
            t.parent.type === "ElementNode" ||
            t.parent.type === "Template")
        )
          return "";
        x && M
          ? ((H = Math.min(M, fn)), (X = 0))
          : ((((o = t.next) == null ? void 0 : o.type) === "BlockStatement" ||
              ((c = t.next) == null ? void 0 : c.type) === "ElementNode") &&
              (X = Math.max(X, 1)),
            (((p = t.previous) == null ? void 0 : p.type) ===
              "BlockStatement" ||
              ((h = t.previous) == null ? void 0 : h.type) === "ElementNode") &&
              (H = Math.max(H, 1)));
        let ve = "",
          Ae = "";
        return (
          X === 0 &&
            ((d = t.next) == null ? void 0 : d.type) === "MustacheStatement" &&
            (Ae = " "),
          H === 0 &&
            ((N = t.previous) == null ? void 0 : N.type) ===
              "MustacheStatement" &&
            (ve = " "),
          C && ((H = 0), (ve = "")),
          v && ((X = 0), (Ae = "")),
          K.hasLeadingWhitespace(g) && (g = ve + K.trimStart(g)),
          K.hasTrailingWhitespace(g) && (g = K.trimEnd(g) + Ae),
          [...rt(H), Xt(hn(g)), ...rt(X)]
        );
      }
  ...
  function Ps(t, e) {
    let { node: r } = t,
      ...
      s = n.flatMap((i) => r[i]).sort(As);
    for (let i of n)
      t.each(({ node: a }) => {
        let o = s.indexOf(a);
        s.splice(o, 1, [D, e()]);
      }, i);
    return Je(r.blockParams) && s.push(D, ir(r)), ["<", r.tag, R(s), xs(r)];
  }
  function an(t, e, r) {
    let { node: n } = t,
  ...
  function _s(t, e) {
    ...
    return (
      s && n.push(q(s)),
      Je(r.program.blockParams) && n.push(ir(r.program)),
      q([Cs(r), sr(t, e), n.length > 0 ? R([D, Ee(D, n)]) : "", Y, Ls(r)])
    );
  }
  function Ds(t, e) {
    return [
      e.htmlWhitespaceSensitivity === "ignore" ? ye : "",
      dn(t),
      "else",
      mn(t),
    ];
  ...
  var gn = (t, e) =>
    t.head.type === "VarHead" &&
    e.head.type === "VarHead" &&
    t.head.name === e.head.name;
  function Os(t) {
    var n;
    let { grandparent: e, node: r } = t;
    return (
      ((n = e == null ? void 0 : e.inverse) == null
        ? void 0
        : n.body.length) === 1 &&
      e.inverse.body[0] === r &&
      gn(e.inverse.body[0].path, e.path)
    );
  }
  function Bs(t, e) {
    ...
    return q([
      ...
      R([
        D,
        q(St(t, e)),
        ...(Je(r.program.blockParams) ? [D, ir(r.program)] : []),
      ]),
      Y,
      mn(n),
    ]);
  ...
  function Rs(t) {
    return (
      yn(t) &&
      t.inverse.body.length === 1 &&
      t.inverse.body[0].type === "BlockStatement" &&
      gn(t.inverse.body[0].path, t.path)
    );
  }
  function yn(t) {
...
`).length - 1
  ...
  function Us(t, e) {
    let {
      ...
      n = gt(r, Fs(t) ? !e.singleQuote : e.singleQuote);
    return [n, Wt(!1, r, n, `\\${n}`), n];
  }
  function Fs(t) {
    let { ancestors: e } = t,
  ...
  function St(t, e) {
    ...
    let { node: r } = t,
      n = [];
    return (
      r.params.length > 0 && n.push(...t.map(e, "params")),
      ((s = r.hash) == null ? void 0 : s.pairs.length) > 0 && n.push(e("hash")),
      n.length === 0 ? "" : Ee(D, n)
    );
  }
  function ir(t) {
  ...
  var zs = new Set("!\"#%&'()*+,./;<=>@[\\]^`{|}~"),
    Gs = new Set(["true", "false", "null", "undefined"]),
    Ys = (t, e) =>
      e === 0 && t.startsWith("@")
        ? !1
        : (e !== 0 && Gs.has(t)) ||
          /\s/u.test(t) ||
          /^\d/u.test(t) ||
          Array.prototype.some.call(t, (r) => zs.has(r));
  function Ks(t) {
    return t.tail.length === 0 && t.original.includes("/")
      ? t.original
      ...
      e = (n) => {
        ...
        return (
          ...
          "toString" in n &&
            ...
            n.toString !== Function.prototype.toString &&
            (s = n.toString()),
          s &&
          /<.*:ember\d+>/u.test(s) &&
          i &&
  ...
  var ar = (function (t) {
    return (
      (t[(t.MAX_SMI = 1073741823)] = "MAX_SMI"),
      (t[(t.MIN_SMI = -1073741824)] = "MIN_SMI"),
      (t[(t.SIGN_BIT = -536870913)] = "SIGN_BIT"),
      (t[(t.MAX_INT = 536870911)] = "MAX_INT"),
      (t[(t.MIN_INT = -536870912)] = "MIN_INT"),
      (t[(t.FALSE_HANDLE = 0)] = "FALSE_HANDLE"),
      (t[(t.TRUE_HANDLE = 1)] = "TRUE_HANDLE"),
      (t[(t.NULL_HANDLE = 2)] = "NULL_HANDLE"),
      (t[(t.UNDEFINED_HANDLE = 3)] = "UNDEFINED_HANDLE"),
      (t[(t.ENCODED_FALSE_HANDLE = 0)] = "ENCODED_FALSE_HANDLE"),
      (t[(t.ENCODED_TRUE_HANDLE = 1)] = "ENCODED_TRUE_HANDLE"),
      (t[(t.ENCODED_NULL_HANDLE = 2)] = "ENCODED_NULL_HANDLE"),
      (t[(t.ENCODED_UNDEFINED_HANDLE = 3)] = "ENCODED_UNDEFINED_HANDLE"),
      t
    );
  })({});
  function Qs(t) {
    return t & ar.SIGN_BIT;
  }
  function Xs(t) {
    return t | ~ar.SIGN_BIT;
  }
  ...
  function ei(t) {
    return (t |= 0), t < 0 ? Qs(t) : Js(t);
  }
  function ti(t) {
    return (t |= 0), t > ar.SIGN_BIT ? Zs(t) : Xs(t);
  }
  [1, -1].forEach((t) => ti(ei(t)));
  var or = Object.assign;
  var ri = console,
    wn = console;
  function vn(t, e = "unexpected unreachable branch") {
    throw (
      (wn.log("unreachable", t),
      wn.log(`${e} :: ${JSON.stringify(t)} (${t})`),
      ...
      var t = function (ie, m, E, b) {
        ...
        Rt = {
          ...
          performAction: function (m, E, b, y, P, l, xe) {
            ...
            switch (P) {
              ...
              case 19:
                ...
                (Me.chained = !0),
                  (this.$ = { strip: l[u - 2].strip, program: Me, chain: !0 });
                break;
              case 21:
                this.$ = {
                  path: l[u - 1],
              ...
              case 22:
              case 23:
                this.$ = y.prepareMustache(
                  l[u - 3],
                  l[u - 2],
                  l[u - 1],
                  l[u - 4],
                  y.stripFlags(l[u - 4], l[u]),
                  this._$,
                );
                break;
              case 24:
          ...
          table: [
            ...
            t(H, X),
            t(ve, [2, 80], { 53: 53 }),
            { 25: 54, 38: 56, 39: Ae, 43: 57, 44: J, 45: 55, 47: [2, 52] },
            ...
            { 55: [2, 83] },
            t(n, [2, 13]),
            { 38: 56, 39: Ae, 43: 57, 44: J, 45: 112, 46: 111, 47: [2, 74] },
            t(V, [2, 68], { 40: 113 }),
            { 47: [2, 18] },
            t(n, [2, 14]),
            { 33: [1, 114] },
          ...
          parse: function (m) {
            ...
            for (
              var ts = function () {
                  ...
                  return (
                    (W = L.lex() || Vr),
                    typeof W != "number" && (W = E.symbols_[W] || W),
                    W
                  );
                },
                I,
              ...
              if (
                ...
                this.defaultActions[ge]
                  ? (z = this.defaultActions[ge])
                  : ((I === null || typeof I > "u") && (I = ts()),
                    (z = xe[ge] && xe[ge][I])),
                ...
                case 2:
                  if (
                    ...
                    (Ft = this.performAction.apply(
                      Ce,
                      [u, Me, ae, me.yy, z[1], P, l].concat(Zn),
                    )),
                    typeof Ft < "u")
                  )
                    return Ft;
                  Z &&
                    ...
                    P.push(Ce.$),
                    l.push(Ce._$),
                    (Ur = xe[b[b.length - 2]][b[b.length - 1]]),
                    b.push(Ur);
                  break;
                case 3:
                  return !0;
            ...
            unput: function (m) {
              ...
              return (
                (this.yylloc = {
                  ...
                  last_column: b
                    ? (b.length === y.length ? this.yylloc.first_column : 0) +
                      y[y.length - b.length].length -
                      b[0].length
                    : this.yylloc.first_column - E,
                }),
                this.options.ranges &&
                  (this.yylloc.range = [P[0], P[0] + this.yyleng - E]),
...
` +
            ...
            pastInput: function () {
              ...
              return (
                (m.length > 20 ? "..." : "") + m.substr(-20).replace(/\n/g, "")
              );
            },
...
` +
            ...
            next: function () {
              ...
              for (var P = this._currentRules(), l = 0; l < P.length; l++)
                if (
                  ((b = this._input.match(this.rules[P[l]])),
                  b && (!E || b[0].length > E[0].length))
                ) {
...
` +
  ...
  At.prototype = {
    ...
    acceptRequired: function (t, e) {
      if ((this.acceptKey(t, e), !t[e]))
        throw new le(t.type + " requires " + e);
    },
        ...
        o.close && ke(n, s, !0),
          ...
          e &&
            ...
            ce(n, s) &&
              ...
              (a.indent = /([ \t]+$)/.exec(n[s - 1].original)[1])),
          e && h && (ke((a.program || a.inverse).body), ce(n, s)),
          e && d && (ke(n, s), ce((a.inverse || a.program).body));
      }
    }
    return t;
  };
    ...
    j.prototype.PartialBlockStatement =
      function (t) {
        ...
        var i = {
          ...
          openStandalone: hr(e.body),
          closeStandalone: ur((n || e).body),
        };
        if ((t.openStrip.close && ke(e.body, null, !0), r)) {
          var a = t.inverseStrip;
          a.open && ce(e.body, null, !0),
            a.close && ke(n.body, null, !0),
            t.closeStrip.open && ce(s.body, null, !0),
  ...
  var Ln = {};
  for (xt in nt)
    Object.prototype.hasOwnProperty.call(nt, xt) && (Ln[xt] = nt[xt]);
  var xt;
  function Ct(t, e) {
    if (t.type === "Program") return t;
    (vt.yy = Ln),
      (vt.yy.locInfo = function (n) {
        return new fr(e && e.srcName, n);
      });
    var r = vt.parse(t);
    return r;
  }
      ...
      return (
        (t.prototype.parse = function (e) {
          if (e) {
            ...
            if (((r = e.match(mi)), r)) return this.named[r[1]];
          }
        }),
        t
      );
...
`
            ...
            data: function () {
              ...
              s === "<" && !this.isIgnoredEndTag()
                ...
                : s === "&" && i !== "script" && i !== "style"
                  ...
                  : (this.consume(), this.delegate.appendToData(s));
            },
            tagOpen: function () {
              var s = this.consume();
              s === "!"
            ...
            beforeDoctypeName: function () {
              ...
              B(s) ||
                ...
                this.delegate.appendToDoctypeName &&
                  this.delegate.appendToDoctypeName(s.toLowerCase()));
            },
              ...
              s === '"'
                ...
                : s === ">"
                  ...
                  : this.delegate.appendToDoctypePublicIdentifier &&
                    this.delegate.appendToDoctypePublicIdentifier(s);
            },
              ...
              s === '"'
                ...
                : s === ">"
                  ...
                  : this.delegate.appendToDoctypeSystemIdentifier &&
                    this.delegate.appendToDoctypeSystemIdentifier(s);
            },
              ...
              s === "-"
                ...
                : s === ">"
                  ? (this.delegate.finishComment(),
                    this.transitionTo("beforeData"))
                  : (this.delegate.appendToCommentData(s),
                  ...
                  : s === ">"
                    ...
                    : s === "="
                      ? (this.delegate.reportSyntaxError(
                        ...
                        this.consume(),
                        this.delegate.appendToAttributeName(s))
                      : (this.transitionTo("attributeName"),
                        this.delegate.beginAttribute());
            },
                  ...
                  : s === "'"
                    ...
                    : s === ">"
                      ...
                      : (this.transitionTo("attributeValueUnquoted"),
                        this.delegate.beginAttributeValue(!1),
                        this.consume(),
                        this.delegate.appendToAttributeValue(s));
            },
      ...
      return (
        ...
        (t.prototype.tokenizePart = function (e) {
          for (this.input += Ei(e); this.index < this.input.length; ) {
...
`
    ...
    Yo = (function () {
      function t(e, r) {
        r === void 0 && (r = {}),
          ...
          (this.startColumn = 0),
          (this.tokens = []),
          (this.tokenizer = new gr(this, e, r.mode)),
      ...
      return (
        ...
        (t.prototype.current = function () {
          ...
          for (var r = 0; r < arguments.length; r++)
            if (e.type === arguments[r]) return e;
  ...
  var Wo = On(br.FlushElement);
  var $o = On(br.GetSymbol);
  var Si = /["&\xA0]/u,
    sl = new RegExp(Si.source, "gu"),
    wi = /[&<>\xA0]/u,
    il = new RegExp(wi.source, "gu");
  var Tr = new Set([
    "area",
    "base",
    "br",
  ...
  function ki(t) {
    var e;
    return (
      Tr.has(t.toLowerCase()) &&
      ((e = t[0]) == null ? void 0 : e.toLowerCase()) === t[0]
    );
  }
  var pe = Object.freeze({ line: 1, column: 0 }),
    Ti = Object.freeze({ source: "(synthetic)", start: pe, end: pe }),
    st = Object.freeze({ source: "(nonexistent)", start: pe, end: pe }),
    ue = Object.freeze({ source: "(broken)", start: pe, end: pe }),
    k = (function (t) {
      return (
        (t.CharPosition = "CharPosition"),
        (t.HbsPosition = "HbsPosition"),
        (t.InternalsSynthetic = "InternalsSynthetic"),
  ...
  var Ar = class {
    ...
    matchFor(e, r) {
      ...
      w(
        we(n),
        `no match defined for (${e}, ${r}) and no AnyMatch defined either`,
      );
      let s = new vr(n).first(r);
      return (
        w(
          s !== null,
          `no match defined for (${e}, ${r}) and no AnyMatch defined either`,
  ...
  var Pr = class t {
    ...
    O = class t {
      ...
      constructor(e) {
        (this.data = e),
          (this.isInvisible =
            e.kind !== k.CharPosition && e.kind !== k.HbsPosition);
      }
      getStart() {
      ...
      toSlice(e) {
        ...
        return !1, new Pr({ loc: this, chars: e || r });
      }
      get start() {
        return this.loc.start;
      }
      ...
      sliceStartChars({ skipStart: e = 0, chars: r }) {
        return Q(
          this.getStart().move(e).data,
          this.getStart().move(e + r).data,
        );
      }
    ...
    at = class {
      ...
      toHbsSpan() {
        ...
        if (e === null) {
          ...
          r === null || n === null
            ? (e = this._locPosSpan = fe)
            : (e = this._locPosSpan =
                new ot(this.source, { start: r, end: n }));
        }
        return e === fe ? null : e;
      }
      serialize() {
    ...
    ot = class {
      ...
      updateProvided(e, r) {
        this._providedHbsLoc && (this._providedHbsLoc[r] = e),
          (this._charPosSpan = null),
          (this._providedHbsLoc = { start: e, end: e });
      }
      locDidUpdate({ start: e, end: r }) {
        e !== void 0 &&
          (this.updateProvided(e, "start"),
          (this.hbsPositions.start = new de(this.source, e, null))),
          r !== void 0 &&
            (this.updateProvided(r, "end"),
            (this.hbsPositions.end = new de(this.source, r, null)));
      }
      asString() {
        let e = this.toCharPosSpan();
      ...
      toCharPosSpan() {
        ...
        if (e === null) {
          ...
          if (r && n)
            e = this._charPosSpan = new at(this.source, { start: r, end: n });
    ...
    Q = Hn((t) =>
      t
        .when(k.HbsPosition, k.HbsPosition, (e, r) =>
          new ot(e.source, { start: e, end: r }).wrap(),
        )
        .when(k.CharPosition, k.CharPosition, (e, r) =>
          new at(e.source, { start: e, end: r }).wrap(),
        )
        ...
        .when(Nr, it, (e) => new te(e.kind, ue).wrap())
        .when(it, Nr, (e, r) => new te(r.kind, ue).wrap()),
    ),
    fe = "BROKEN",
    Ue = class t {
    ...
    Ne = class {
      ...
      toHbsPos() {
        ...
        if (e === null) {
          ...
          r === null
            ? (this._locPos = e = fe)
            : (this._locPos = e = new de(this.source, r, this.charPos));
        }
        return e === fe ? null : e;
      }
    },
    de = class {
      ...
      constructor(e, r, n = null) {
        (this.source = e),
          (this.hbsPos = r),
          (this._charPos = n === null ? null : new Ne(e, n));
      }
      toCharPos() {
        let e = this._charPos;
        if (e === null) {
          ...
          r === null
            ? (this._charPos = e = fe)
            : (this._charPos = e = new Ne(this.source, r));
        }
        return e === fe ? null : e;
      }
      toJSON() {
    ...
    vi = Hn((t) =>
      t
        .when(
          ...
          k.HbsPosition,
          ({ hbsPos: e }, { hbsPos: r }) =>
            e.column === r.column && e.line === r.line,
        )
        .when(
          k.CharPosition,
          k.CharPosition,
          ({ charPos: e }, { charPos: r }) => e === r,
        )
...
`,
          ...
          if ((c === -1 && (c = this.source.length), a === r - 1)) {
            ...
            if (!1) {
              ...
              w(p !== null, "the returned offset failed to round-trip"),
                w(
                  p.line === r,
...
`
        : "",
      c = new Error(
        `${t}: ${o}(error occurred in '${r}' @ line ${s} : column ${i})`,
      );
  ...
  var Fe = class {
      ...
      parents() {
        return { [Symbol.iterator]: () => new xr(this) };
      }
    },
    xr = class {
      path;
  ...
  function Ci(t, e) {
    if (
      t.Program &&
      ((e === "Template" && !t.Template) || (e === "Block" && !t.Block))
    )
      return (
        F(
          `The 'Program' visitor node is deprecated. Use 'Template' or 'Block' instead (node was '${e}') `,
        ),
        t.Program
      );
    let r = t[e];
  ...
  function Di(t, e, r, n) {
    ...
    if (Array.isArray(n))
      ...
      else throw n.length === 0 ? Bn(r, t, e) : Pi(r, t, e);
    else Rn(t, e, n);
  }
  function Oi(t, e, r) {
    return r === null
  ...
  function Mn(t) {
    return (
      ...
      t.type === "NullLiteral" ||
      t.type === "UndefinedLiteral"
    );
  }
  function Ri(t) {
    return t.type === "UndefinedLiteral"
      ? "undefined"
      : JSON.stringify(t.value);
  }
  var yr;
  function Er() {
    return yr || (yr = new Te("", "(synthetic)")), yr;
  }
  function qi(t, e = [], r = ct([]), n = !1, s, i) {
    return f.mustache({
      path: he(t),
      params: e,
      hash: r,
  ...
  function Hi(t, e, r, n, s = null, i, a, o, c) {
    let p,
      h = null;
    return (
      n.type === "Template"
        ...
        : (p = n),
      (s == null ? void 0 : s.type) === "Template"
        ? (F("b.program is deprecated. Use b.blockItself instead."),
          w(
            s.blockParams.length === 0,
            "{{else}} block cannot have block params",
          ),
          (h = f.blockItself({ params: [], body: s.body, loc: s.loc })))
        : (h = s),
      f.block({
        path: he(t),
        params: e || [],
  ...
  function zi(t, e = {}) {
    ...
    typeof t == "string"
      ? t.endsWith("/")
        ? ((h = he(t.slice(0, -1))), (d = !0))
        : (h = he(t))
      : "type" in t
        ? (w(t.type === "PathExpression", `Invalid tag type ${t.type}`),
          (h = t))
        : "path" in t
          ? (w(
              t.path.type === "PathExpression",
              `Invalid tag type ${t.path.type}`,
            ),
            (h = t.path),
            (d = t.selfClosing))
          : ((h = he(t.name)), (d = t.selfClosing)),
      d &&
        w(
          c == null,
    ...
    let N =
        n == null ? void 0 : n.map((T) => (typeof T == "string" ? zn(T) : T)),
      g = null;
    return (
      c
        ? (g = A(c || null))
        : c === void 0 && (g = d || ki(h.original) ? null : A(null)),
      f.element({
        path: h,
        selfClosing: d || !1,
        attributes: r || [],
  ...
  function Zi(t, e, r) {
    return (
      F("b.program is deprecated. Use b.template or b.blockItself instead."),
      e && e.length ? Yn(t, e, !1, r) : Kn(t, [], r)
    );
  }
  function Gn(t) {
    return t.map((e) =>
      typeof e == "string" ? f.var({ name: e, loc: O.synthetic(e) }) : e,
    );
  }
  ...
  var ta = {
    ...
    var: zn,
    this: $i,
    string: Sr("StringLiteral"),
    boolean: Sr("BooleanLiteral"),
    number: Sr("NumberLiteral"),
    undefined() {
  ...
  function ra({ path: t, params: e, hash: r, trusting: n, strip: s, loc: i }) {
    let a = {
    ...
    return (
      Object.defineProperty(a, "escaped", {
        ...
        get() {
          return (
            F(
              "The escaped property on mustache nodes is deprecated, use trusting instead",
            ),
            !this.trusting
          );
        },
  ...
  function na({ head: t, tail: e, loc: r }) {
    let n = {
      type: "PathExpression",
      head: t,
      tail: e,
      ...
      set original(s) {
        let [i, ...a] = qe(s.split("."));
        (this.head = ta.head(i, this.head.loc)), (this.tail = a);
      },
      loc: r,
    };
    return (
      Object.defineProperty(n, "parts", {
        ...
        get() {
          F(
            "The parts property on path nodes is deprecated, use head and tail instead",
          );
          let s = qe(this.original.split("."));
          return (
            s[0] === "this"
              ? s.shift()
              : s[0].startsWith("@") && (s[0] = s[0].slice(1)),
            Object.freeze(s)
          );
        },
        set(s) {
          var a;
          F(
            "The parts property on mustache nodes is deprecated, use head and tail instead",
          );
          let i = [...s];
          i[0] !== "this" &&
            !((a = i[0]) != null && a.startsWith("@")) &&
            (this.head.type === "ThisHead"
              ? i.unshift("this")
              : this.head.type === "AtHead" && (i[0] = `@${i[0]}`)),
            (this.original = i.join("."));
        },
      }),
      Object.defineProperty(n, "this", {
        ...
        get() {
          return (
            F(
              "The this property on path nodes is deprecated, use head.type instead",
            ),
            this.head.type === "ThisHead"
          );
        },
      ...
      Object.defineProperty(n, "data", {
        ...
        get() {
          return (
            F(
              "The data property on path nodes is deprecated, use head.type instead",
            ),
            this.head.type === "AtHead"
          );
        },
      }),
      n
  ...
  function sa({ type: t, value: e, loc: r }) {
    ...
    return (
      Object.defineProperty(n, "original", {
        ...
        get() {
          return (
            F(
              "The original property on literal nodes is deprecated, use value instead",
            ),
            this.value
          );
        },
  ...
  var Lt = { close: !1, open: !1 },
    Cr = class {
        ...
        return {
          ...
          set selfClosing(N) {
            (d = N),
              N
                ? (this.closeTag = null)
                : (this.closeTag = O.synthetic(`</${this.tag}>`));
          },
        };
      }
      ...
      path({ head: e, tail: r, loc: n }) {
        return na({ head: e, tail: r, loc: n });
      }
      head({ original: e, loc: r }) {
        return e === "this"
          ? this.this({ loc: r })
          : e[0] === "@"
            ? this.atName({ name: e, loc: r })
            : this.var({ name: e, loc: r });
      }
      this({ loc: e }) {
        return {
          type: "ThisHead",
        ...
        let n = "",
          s = {
            ...
            set name(i) {
              w(
                i[0] === "@",
                "call builders.at() with a string that starts with '@'",
              ),
                w(
                  i.indexOf(".") === -1,
          ...
          s = {
            ...
            set name(i) {
              w(
                ...
                w(
                  i[0] !== "@",
                  `You called builders.var() with '${e}'. Call builders.at('${e}') instead`,
                ),
                w(
                  i.indexOf(".") === -1,
      ...
      literal({ type: e, value: r, loc: n }) {
        return sa({ type: e, value: r, loc: n });
      }
    },
    f = new Cr(),
    Lr = class {
      ...
      currentNode = null;
      tokenizer;
      constructor(e, r = new mr(Dn), n = "precompile") {
        (this.source = e),
          (this.lines = e.source.split(/\r\n?|\n/u)),
          (this.tokenizer = new gr(this, r, n));
      }
      offset() {
      ...
      finish(e) {
        return or({}, e, { loc: e.start.until(this.offset()) });
      }
      get currentAttr() {
      ...
      get currentTag() {
        ...
        return (
          w(
            e && (e.type === "StartTag" || e.type === "EndTag"),
            "expected tag",
          ),
          e
        );
      ...
      sourceForNode(e, r) {
        ...
        for (
          r
            ? ((c = r.loc.end.line - 1), (p = r.loc.end.column))
            : ((c = e.loc.end.line - 1), (p = e.loc.end.column));
          s < c;
...
`);
    ...
    _r = class extends Lr {
      ...
      parseProgram(e, r) {
        ...
        if (e !== n) {
          if ((n == null ? void 0 : n.type) === "ElementNode")
            throw S(`Unclosed element \`${n.tag}\``, n.loc);
          w(n !== void 0, "[BUG] empty parser elementStack"),
            w(!1, `[BUG] mismatched parser elementStack node: ${e.type}`);
        }
        return e;
      }
      BlockStatement(e) {
        ...
        let { path: r, params: n, hash: s } = wr(this, e),
          i = this.source.spanFor(e.loc),
          a = [];
        if ((d = e.program.blockParams) != null && d.length) {
          let N = s.loc.collapse("end");
          e.program.loc
            ? (N = N.withEnd(this.source.spanFor(e.program.loc).getStart()))
            : e.program.body[0]
              ? (N = N.withEnd(
                  this.source.spanFor(e.program.body[0].loc).getStart(),
                ))
              : (N = N.withEnd(i.getEnd()));
          let g = N.asString(),
            T = g.indexOf("|") + 1,
            x = g.indexOf("|", T);
          for (let C of e.program.blockParams) {
            ...
            T >= x ? (v = -1) : (v = g.indexOf(C, T)),
              v === -1 || v + C.length > x
                ...
                : ((T = v),
                  (M = N.sliceStartChars({ skipStart: T, chars: C.length })),
                  (T += C.length)),
              a.push(f.var({ name: C, loc: M }));
          }
        }
        e.program.loc || (e.program.loc = st),
          e.inverse && !e.inverse.loc && (e.inverse.loc = st);
      ...
      MustacheStatement(e) {
        var o;
        (o = this.pendingError) == null ||
          o.mustache(this.source.spanFor(e.loc));
        ...
        if ("original" in e.path && e.path.original === "...attributes")
          throw S("Illegal use of ...attributes", this.source.spanFor(e.loc));
        if (Mn(e.path))
          n = f.mustache({
          ...
          let { path: c, params: p, hash: h } = wr(this, e);
          n = f.mustache({
            path: c,
            params: p,
            hash: h,
        ...
        switch (r.state) {
          ...
          case "afterAttributeValueQuoted":
            kr(this.currentStartTag, n), r.transitionTo(qn);
            break;
      ...
      CommentStatement(e) {
        ...
        let { value: n, loc: s } = e,
          i = f.mustacheComment({ value: n, loc: this.source.spanFor(s) });
        switch (r.state) {
          case "beforeAttributeName":
          case "afterAttributeName":
...
`).length - 1,
  ...
  function oa(t, e) {
    let r = e.loc.start.line,
      ...
      s = aa(e.original, e.value);
    (r = r + s.lines),
      s.lines ? (n = s.columns) : (n = n + s.columns),
      (t.line = r),
      (t.column = n);
  }
  function wr(t, e) {
    ...
    switch (e.path.type) {
      ...
      case "BooleanLiteral": {
        let a;
        throw (
          (e.path.type === "BooleanLiteral"
            ? (a = e.path.original.toString())
            : e.path.type === "StringLiteral"
              ? (a = `"${e.path.original}"`)
              : e.path.type === "NullLiteral"
                ? (a = "null")
                : e.path.type === "NumberLiteral"
                  ? (a = e.path.value.toString())
                  : (a = "undefined"),
          S(
            `${e.path.type} "${e.path.type === "StringLiteral" ? e.path.original : a}" cannot be called as a sub-expression, replace (${a}) with ${a}`,
    ...
    let n = e.params ? e.params.map((a) => t.acceptNode(a)) : [],
      ...
      i = e.hash
        ? t.Hash(e.hash)
        : f.hash({ pairs: [], loc: t.source.spanFor(s).collapse("end") });
  ...
  var Dr = class extends _r {
      ...
      finishTag() {
        ...
        if (e.type === "StartTag") {
          ...
          (Tr.has(e.name) || e.selfClosing) && this.finishEndTag(!0);
        } else e.type === "EndTag" && this.finishEndTag(!1);
      }
      finishStartTag() {
        let { name: e, nameStart: r, nameEnd: n } = this.currentStartTag;
        w(e !== "", "tag name cannot be empty"),
          w(r !== null, "nameStart unexpectedly null"),
          w(n !== null, "nameEnd unexpectedly null");
        let s = r.until(n),
          [i, ...a] = qe(e.split(".")),
          o = f.path({
            head: f.head({
      ...
      finishEndTag(e) {
        ...
        e
          ? (s.closeTag = null)
          : s.selfClosing
            ? w(s.closeTag === null, "element.closeTag unexpectedly present")
            : (s.closeTag = r.until(this.offset())),
          (s.loc = s.loc.withEnd(this.offset())),
          Ve(i, f.element(s));
      }
      ...
      appendToTagName(e) {
        ...
        if (((r.name += e), r.type === "StartTag")) {
          let n = this.offset();
          r.nameStart === null &&
            (w(r.nameEnd === null, "nameStart and nameEnd must both be null"),
            (r.nameStart = n.move(-1))),
            (r.nameEnd = n);
        }
      }
      beginAttribute() {
...
`
      ...
      finishAttributeValue() {
        ...
        if (e.type === "EndTag")
          throw S(
            ...
            this.source.spanFor({ start: e.start.toJSON(), end: r.toJSON() }),
          );
        let {
          name: n,
          parts: s,
      ...
      parsePossibleBlockParams() {
        ...
        let i = this.currentStartTag,
          ...
          c = {
            PossibleAs: (h) => {
              if (
                (w(o.state === "PossibleAs", "bug in block params parser"),
                He(h))
              )
                (o = { state: "BeforeStartPipe" }),
                  this.tokenizer.transitionTo(n),
                  this.tokenizer.consume();
              else {
                if (h === "|")
                  throw S(
                    'Invalid block parameters syntax: expecting at least one space character between "as" and "|"',
                    a.start.until(this.offset().move(1)),
                  );
                o = { state: "Done" };
              }
            },
            BeforeStartPipe: (h) => {
              w(o.state === "BeforeStartPipe", "bug in block params parser"),
                He(h)
                  ? this.tokenizer.consume()
                  : h === "|"
                    ? ((o = { state: "BeforeBlockParamName" }),
                      this.tokenizer.transitionTo(e),
                      this.tokenizer.consume())
                    : (o = { state: "Done" });
            },
            ...
            BlockParamName: (h) => {
              if (
                (w(o.state === "BlockParamName", "bug in block params parser"),
                h === "")
              )
                (o = { state: "Done" }),
                  (this.pendingError = {
                ...
                if (o.name === "this" || s.test(o.name))
                  throw S(
                    `Invalid block parameters syntax: invalid identifier name \`${o.name}\``,
                    d,
                  );
                i.params.push(f.var({ name: o.name, loc: d })),
                  (o =
                    h === "|"
                      ? { state: "AfterEndPipe" }
            ...
            Error: (h) => {
              if (
                (w(o.state === "Error", "bug in block params parser"),
                h === "" || h === "/" || h === ">" || He(h))
              )
                throw S(o.message, o.start.until(this.offset()));
              this.tokenizer.consume();
            },
            Done: () => {
      ...
      assembleConcatenatedValue(e) {
        for (let s of e)
          if (s.type !== "MustacheStatement" && s.type !== "TextNode")
            throw S(
              `Unsupported node in quoted attribute value: ${s.type}`,
              s.loc,
            );
      ...
      validateEndTag(e, r, n) {
        if (Tr.has(e.name) && !n)
          throw S(
            `<${e.name}> elements do not need end tags. You should remove it`,
            e.loc,
          );
        if (r.tag === void 0)
          throw S(`Closing tag </${e.name}> without an open tag`, e.loc);
        if (r.tag !== e.name)
          throw S(
            `Closing tag </${e.name}> did not match last open tag <${r.tag}> (on line ${r.loc.startPosition.line})`,
            e.loc,
          );
      }
  ...
  function Wn(t, e = {}) {
    ...
    let r = e.mode || "precompile",
      ...
      s;
    typeof t == "string"
      ? ((n = new Te(t, (c = e.meta) == null ? void 0 : c.moduleName)),
        r === "codemod"
          ? (s = Ct(t, e.parseOptions))
          : (s = dr(t, e.parseOptions)))
      : t instanceof Te
        ? ((n = t),
          r === "codemod"
            ? (s = Ct(t.source, e.parseOptions))
            : (s = dr(t.source, e.parseOptions)))
        : ((n = new Te("", (p = e.meta) == null ? void 0 : p.moduleName)),
          (s = t));
    let i;
    r === "codemod" && (i = new Or());
    let a = O.forCharPositions(n, 0, n.source.length);
    s.loc = { source: "(program)", start: a.startPosition, end: a.endPosition };
    let o = new Dr(n, i, r).parse(s, e.locals ?? []);
    if ((h = e == null ? void 0 : e.plugins) != null && h.ast)
      for (let d of e.plugins.ast) {
        let N = or({}, e, { syntax: la }, { plugins: void 0 }),
          g = d(N);
        Bi(o, g.visitor);
      }
    return o;
...
`,
  ...
  function ua(t) {
    ...
    if (e)
      for (let r = 0; r < e.length - 1; r++)
        e[r].type === "TextNode" &&
          e[r + 1].type === "MustacheStatement" &&
          (e[r].chars = e[r].chars.replace(/\\$/u, "\\\\"));
  }
  function ha(t) {
    let e = new jn(t),
      r = ({ line: s, column: i }) =>
        e.indexForLocation({ line: s - 1, column: i }),
      n = (s) => {
  ...
  function pa(t) {
    let e;
    try {
      e = Wn(t, { mode: "codemod", plugins: { ast: [ha(t)] } });
    } catch (r) {
      let n = da(r);
      if (n) {
        let s = fa(r);
...
`);
    return r.length >= 4 &&
      ...
      : r.length >= 4 &&
          ...
          r[1] === "" &&
          oe(!1, r, -2) === "" &&
          r.slice(2, -2).every((n) => n.startsWith("|"))
        ? r[0].trim().slice(0, -1)
        : e;
  }
  function da(t) {
  ...
  var ma = { parse: pa, astFormat: "glimmer", locStart: Se, locEnd: tt };
  var ga = { glimmer: En };
  return as(ba);
});

...
function Qr(t, e) {
  ...
  t.type === "ElementNode" &&
    ...
    t.type === "AttrNode" && t.name.toLowerCase() === "class" && delete e.value,
...
function ws(t, e, r) {
  ...
  switch (n.type) {
    ...
    case "BlockStatement":
      return Cs(t)
        ? [Ls(t, r), cn(t, r, e), un(t, r, e)]
        : [Ps(t, r), q([cn(t, r, e), un(t, r, e), _s(t, r, e)])];
    ...
    case "TextNode": {
      ...
      x && M
        ...
        : ((((o = t.next) == null ? void 0 : o.type) === "BlockStatement" ||
            ...
            (X = Math.max(X, 1)),
          (((p = t.previous) == null ? void 0 : p.type) === "BlockStatement" ||
...
function Ps(t, e) {
  ...
  return (
    s && n.push(q(s)),
    Je(r.program.blockParams) && n.push(sr(r.program)),
    q([vs(r), nr(t, e), n.length > 0 ? R([D, Ee(D, n)]) : "", Y, As(r)])
  );
}
function xs(t, e) {
  return [
...
function Cs(t) {
  ...
  return (
    ((n = e == null ? void 0 : e.inverse) == null ? void 0 : n.body.length) ===
      1 &&
    e.inverse.body[0] === r &&
...
function Ls(t, e) {
  ...
  return q([
    ...
    R([
      D,
      q(St(t, e)),
      ...(Je(r.program.blockParams) ? [D, sr(r.program)] : []),
    ]),
    Y,
    mn(n),
  ]);
  ...
  Fs = (t, e) =>
    e === 0 && t.startsWith("@")
      ...
      : (e !== 0 && Us.has(t)) ||
        /\s/u.test(t) ||
        /^\d/u.test(t) ||
        Array.prototype.some.call(t, (r) => Vs.has(r));
function Ms(t) {
                ...
                : s === "&"
                  ...
                  : s === ">"
                    ? (this.delegate.finishAttributeValue(),
                      ...
                      this.delegate.finishTag(),
                      this.transitionTo("beforeData"))
                    : (this.consume(), this.delegate.appendToAttributeValue(s));
          },
  ...
  Uo = (function () {
    function t(e, r) {
      r === void 0 && (r = {}),
        ...
        (this.startColumn = 0),
        (this.tokens = []),
        (this.tokenizer = new mr(this, e, r.mode)),
    ...
    toHbsSpan() {
      ...
      if (e === null) {
        ...
        r === null || n === null
          ...
          : (e = this._locPosSpan = new ot(this.source, { start: r, end: n }));
      }
      return e === fe ? null : e;
    }
    serialize() {
...
function Vi(t, e = {}) {
  ...
  typeof t == "string"
    ? t.endsWith("/")
      ...
      : (h = he(t))
    : "type" in t
      ? (w(t.type === "PathExpression", `Invalid tag type ${t.type}`), (h = t))
      : "path" in t
        ? (w(
  ...
  return (
    c
      ? (g = A(c || null))
      : c === void 0 && (g = d || yi(h.original) ? null : A(null)),
    f.element({
      path: h,
      selfClosing: d || !1,
      attributes: r || [],
  ...
  Cr = class {
    ...
    constructor(e, r = new dr(Dn), n = "precompile") {
      (this.source = e),
        ...
        (this.tokenizer = new mr(this, r, n));
    }
    offset() {
    ...
    get currentTag() {
      ...
      return (
        w(e && (e.type === "StartTag" || e.type === "EndTag"), "expected tag"),
        e
      );
    }
    get currentStartTag() {
    ...
    parsePossibleBlockParams() {
      ...
      let i = this.currentStartTag,
        ...
        c = {
          PossibleAs: (h) => {
            if (
              (w(o.state === "PossibleAs", "bug in block params parser"), He(h))
            )
          ...
          BeforeBlockParamName: (h) => {
            if (
              ...
              (o = { state: "BlockParamName", name: h, start: this.offset() }),
                this.tokenizer.consume();
            }
          },
          BlockParamName: (h) => {
  ...
  typeof t == "string"
    ? ((n = new Te(t, (c = e.meta) == null ? void 0 : c.moduleName)),
      r === "codemod"
        ...
        : (s = fr(t, e.parseOptions)))
    : t instanceof Te
      ? ((n = t),
        r === "codemod"
          ? (s = Ct(t.source, e.parseOptions))
          : (s = fr(t.source, e.parseOptions)))

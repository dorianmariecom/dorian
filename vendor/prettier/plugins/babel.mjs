...
var Hs = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports),
  Ws = (a, t) => {
    for (var e in t) je(a, e, { get: t[e], enumerable: !0 });
  },
  Js = (a, t, e, s) => {
...
var vt = (a, t, e) => (
  ...
  Js(
    t || !a || !a.__esModule
      ? je(e, "default", { value: a, enumerable: !0 })
      : e,
    a,
  )
);
...
- Did you mean \`import { "${a}" as foo }\`?`,
      ...
      InvalidLhs: ({ ancestor: a }) => `Invalid left-hand side in ${Ce(a)}.`,
      InvalidLhsBinding: ({ ancestor: a }) =>
        `Binding invalid left-hand side in ${Ce(a)}.`,
      InvalidLhsOptionalChaining: ({ ancestor: a }) =>
        `Invalid optional chaining in the left-hand side of ${Ce(a)}.`,
    ...
    Zs = {
      ...
      PipeUnparenthesizedBody: ({ type: a }) =>
        `Hack-style pipe body cannot be an unparenthesized ${Ce({ type: a })}; please wrap it in parentheses.`,
      PipelineBodyNoArrow:
...
`);
  ...
  function ss(a, t, e, s, i, r, n, o, h, c) {
    let l = t,
      ...
      f = i === 16 ? we.hex : i === 10 ? we.dec : i === 8 ? we.oct : we.bin,
      d = !1,
      y = 0;
  ...
  function is(a, t, e, s, i, r) {
    ...
    if (n === 123) {
      if (
        (++t,
        ({ code: o, pos: t } = Ze(a, t, e, s, a.indexOf("}", t) - t, !0, i, r)),
        ++t,
        o !== null && o > 1114111)
      )
  ...
  var Di = new Set([103, 109, 115, 105, 121, 117, 100, 118]),
    ...
    et = class extends Ye {
      ...
      nextTokenInLineStartSince(t) {
        return (Ie.lastIndex = t), Ie.test(this.input) ? Ie.lastIndex : t;
      }
      ...
      skipBlockComment(t) {
        ...
        for (
          this.state.pos = i + t.length, Se.lastIndex = s + 2;
          Se.test(this.input) && Se.lastIndex <= i;

        )
          ++this.state.curLine, (this.state.lineStart = Se.lastIndex);
      ...
      class extends a {
        ...
        parseConditional(e, s, i) {
          ...
          let r = this.state.clone(),
            ...
            { consequent: h, failed: c } = this.tryParseConditionalConsequent(),
...
`))
    ...
    class extends a {
      ...
      tsParseModifiers(
        ...
        for (;;) {
          ...
          $t(l)
            ? n.accessibility
              ? this.raise(x.DuplicateAccessibilityModifier, c, { modifier: l })
              : (o(c, l, l, "override"),
                o(c, l, l, "static"),
                o(c, l, l, "readonly"),
                (n.accessibility = l))
      ...
      tsParseHeritageClause(e) {
        ...
        return (
          i.length || this.raise(x.EmptyHeritageClauseType, s, { token: e }), i
        );
      }
      ...
      parsePostMemberNameModifiers(e) {
        this.eat(17) && (e.optional = !0),
          ...
          e.declare && this.match(10) && this.raise(x.ClassMethodHasDeclare, e);
      }
      parseExpressionStatement(e, s, i) {
        return (
          (s.type === "Identifier"
      ...
      parseClassProperty(e) {
        if (
          ...
          this.state.isAmbientContext &&
            ...
            this.match(29) &&
            this.raise(x.DeclareClassFieldHasInitializer, this.state.startLoc),
  ...
  var ct = class extends lt {
      ...
      parseSubscript(t, e, s, i) {
        ...
        if (ve(r)) return this.parseTaggedTemplateExpression(t, e, i);
        let n = !1;
        if (r === 18) {
          if (
            s &&
      ...
      parseAsyncArrowUnaryFunction(t) {
        this.prodParam.enter(Ne(!0, this.prodParam.hasYield));
        let e = [this.parseIdentifier()];
        return (
          this.prodParam.exit(),
          this.hasPrecedingLineBreak() &&
...
`,
      ...
      parseMethod(t, e, s, i, r, n, o = !1) {
        this.initFunction(t, s),
          ...
          this.prodParam.enter(Ne(s, t.generator)),
          ...
          (this.state.labels = []),
            ...
            (t.body = this.parseBlock(!0, !1, (o) => {
              ...
              this.checkParams(t, !this.state.strict && !e && !s && !h, e, c),
                this.state.strict && t.id && this.checkIdentifier(t.id, 65, c);
            })),
            this.prodParam.exit(),
            (this.state.labels = n);
        }
  ...
  var pt = class extends ct {
      ...
      parseFunction(t, e = 0) {
        ...
        return (
          (this.state.maybeInArrowParameters = !1),
          this.scope.enter(2),
          this.prodParam.enter(Ne(n, t.generator)),
...
function Lr(a) {
  ...
  return (
    ...
    Be(t, { loc: { start: { line: e, column: s + 1 } }, cause: r })
  );
}
var Re = Lr;
var Dr = (a, t, e, s) => {
...
function Jr({ isExpression: a = !1, optionsCombinations: t }) {
  return (e, s = {}) => {
    ...
    e.includes("|>")
      ...
      : n && (i = i.map((c) => V([ks], c)));
    let o = a ? _e.parseExpression : _e.parse,
      h;
    try {
    ...
    return (
      a && (h = Ue(h, { text: e, rootMarker: s.rootMarker })),
...
function _s(a = {}) {
  ...
  return function (s) {
    ...
    return ae(i), Ue(i, { type: "JsonRoot", text: s });
  };
}
function H(a, t) {
  ...
  return Be(`${t} is not allowed in JSON.`, { loc: { start: e, end: s } });
}
function ae(a) {
  switch (a.type) {
    case "ArrayExpression":
...
var Qr = { ...Rs, ...js };
var Ln = kt;
export { Ln as default, Qr as parsers };

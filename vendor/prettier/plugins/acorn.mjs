...
var et = (e, t, i) => (
  ...
  bi(
    t || !e || !e.__esModule
      ? we(i, "default", { value: e, enumerable: !0 })
      : i,
    e,
  )
);
...
`))
      ...
      jsx_readString(h) {
        ...
        return (
          (m += this.input.slice(x, this.pos++)), this.finishToken(r.string, m)
        );
      }
      jsx_readEntity() {
        let h = "",
...
function Vi(e, t) {
  return function (i, s, r, n, o, u) {
    ...
    e.locations && (p.loc = new xe(this, o, u)),
...
var le = 0,
  ...
  T = function (t, i, s) {
    (this.options = t = Ni(t)),
      ...
      (this.keywords = G(
        _i[t.ecmaVersion >= 6 ? 6 : t.sourceType === "module" ? "5module" : 5],
      ));
    var r = "";
    t.allowReserved !== !0 &&
...
`,
          ...
          (this.curLine = this.input.slice(0, this.lineStart).split(R).length))
  ...
  return this.type === a._in ||
    ...
    ? (t > -1
        ...
        : o &&
          ...
          (l.start === d && !u && l.type === "Identifier" && l.name === "async"
            ? this.unexpected()
...
f.parseExportDefaultDeclaration = function () {
  ...
  if (this.type === a._function || (e = this.isAsyncFunction())) {
    var t = this.startNode();
    return this.next(), e && this.next(), this.parseFunction(t, ee | vt, !1, e);
...
c.regexp_eatNestedClass = function (e) {
  ...
  if (e.eat(91)) {
    ...
    if (e.eat(93))
      return (
        i && s === L && e.raise("Negated character class may contain strings"),
        s
      );
    e.pos = t;
  }
...
v.readWord1 = function () {
  ...
  for (
    ...
    if (z(r, s)) this.pos += r <= 65535 ? 1 : 2;
      ...
      (t ? U : z)(o, s) || this.invalidStringToken(n, "Invalid Unicode escape"),
        (e += K(o)),
        (i = this.pos);
    } else break;
    t = !1;
...
var ba = $e;
export { ba as default, Xs as parsers };

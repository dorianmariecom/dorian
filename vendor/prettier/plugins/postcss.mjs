...
var y = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
  Xs = (t, e) => {
    for (var s in e) Ur(t, s, { get: e[s], enumerable: !0 });
  },
  pl = (t, e, s, r) => {
...
var ye = (t, e, s) => (
  ...
  pl(
    e || !t || !t.__esModule
      ? Ur(s, "default", { value: t, enumerable: !0 })
      : s,
    t,
  )
);
    ...
    function F($) {
      ...
      switch (((i = r.charCodeAt(d)), i)) {
        ...
        case 64: {
          (Yt.lastIndex = d + 1),
            Yt.test(r),
            Yt.lastIndex === 0 ? (o = r.length - 1) : (o = Yt.lastIndex - 2),
...
var Re = y((kv, ro) => {
  ...
  var { SourceMapConsumer: Ac, SourceMapGenerator: Nc } = Ki(),
    { fileURLToPath: Zi, pathToFileURL: Kt } = {},
    ...
    Pe = class {
      ...
      error(e, s, r, n = {}) {
        ...
        return (
          ...
          this.file &&
            (Kt && (i.input.url = Kt(this.file).toString()),
    ...
    function H(T) {
      ...
      switch (((i = r.charCodeAt(h)), i)) {
        ...
        case 64: {
          (er.lastIndex = h + 1),
            er.test(r),
            er.lastIndex === 0 ? (o = r.length - 1) : (o = er.lastIndex - 2),
...
var D = y((B) => {
  ...
  var lx = (B.TAG = "tag"),
    cx = (B.STRING = "string"),
    fx = (B.SELECTOR = "selector"),
    px = (B.ROOT = "root"),
    hx = (B.PSEUDO = "pseudo"),
    dx = (B.NESTING = "nesting"),
    mx = (B.ID = "id"),
    yx = (B.COMMENT = "comment"),
    wx = (B.COMBINATOR = "combinator"),
    gx = (B.CLASS = "class"),
    vx = (B.ATTRIBUTE = "attribute"),
    ...
    for (
      ...
      switch (((r = s.charCodeAt(m)), r === xt && ((h = m), (d += 1)), r)) {
        ...
        case bd:
          ...
          do
            for (
              l = !1, n = s.indexOf(i, n + 1), n === -1 && b("quote", i), w = n;
              s.charCodeAt(w - 1) === Ms;
        ...
        case Nd:
          (xr.lastIndex = m + 1),
            xr.test(s),
            xr.lastIndex === 0 ? (n = s.length - 1) : (n = xr.lastIndex - 2),
  ...
  var dm = (function () {
    function t(e) {
      ...
      return (
        ...
        (this.current = s),
        this.lossy
          ? (this.tokens = (0, Za.default)({ safe: e.safe, css: e.css.trim() }))
    ...
    for (; u < i; ) {
      switch (((p = n.charCodeAt(u)), p === 10 && ((o = u), (a += 1)), p)) {
        ...
        case 34:
          ...
          do
            for (
              v = !1, l = n.indexOf(w, l + 1), l === -1 && H("quote", w), R = l;
              n.charCodeAt(R - 1) === 92;
        ...
        case 64:
          (Dr.lastIndex = u + 1),
            Dr.test(n),
            Dr.lastIndex === 0 ? (l = n.length - 1) : (l = Dr.lastIndex - 2),
...
var Me = "string",
  ...
  ze = "label",
  be = "break-parent",
  bt = new Set([Ue, we, ge, Fe, ve, xe, oe, $e, We, Ye, K, ze, be]);
function dl(t) {
...
function ke(t, e) {
  ...
  return (
    ((r = s == null ? void 0 : s.value) == null ? void 0 : r.toLowerCase()) ===
    e
  );
}
function Bn(t) {
  ...
  let o = t.map(({ node: w, isLast: x, index: h }) => {
      ...
      if (!x && w.type === "value-comma_group" && ee(w.groups)) {
        ...
        !g.source && g.close && (g = g.close),
          g.source && Bt(e.originalText, P(g)) && m.push(E);
      }
      return m;
    }, "groups"),
    a = Xn(r, n),
    ...
    p = u || a,
    l = L(
      [r.open ? s("open") : "", q([M, V(A, o)]), M, r.close ? s("close") : ""],
      { shouldBreak: f },
    );
  return p ? ue(l) : l;
}
...
function oc(t, e, s) {
  ...
  switch (r.type) {
    ...
    case "css-atrule": {
      let f = t.parent,
        p = Pt(r) && !f.raws.semicolon && e.originalText[P(r) - 1] !== ";";
      if (e.parser === "less") {
        if (r.mixin)
          return [
            s("selector"),
...
function Ju(t, e) {
  if (t && typeof t == "object")
    for (let s in t)
      s !== "parent" &&
        (Ju(t[s], e), s === "nodes" && ((t.group = Br(dy(t, e))), delete t[s]));
  return t;
}
function my(t, e) {

(function (n) {
  ...
  var C = (e, r) => () => (r || e((r = { exports: {} }).exports, r), r.exports),
    Pn = (e, r) => {
      for (var t in r) xr(e, t, { get: r[t], enumerable: !0 });
    },
    Ln = (e, r, t, n) => {
  ...
  var Ue = (e, r, t) => (
      ...
      Ln(
        r || !e || !e.__esModule
          ? xr(t, "default", { value: e, enumerable: !0 })
          : t,
        e,
      )
    ),
    ul = (e) => Ln(xr({}, "__esModule", { value: !0 }), e);
  var wr = C((Pm, In) => {
    "use strict";
    In.exports = sl;
    function sl(e) {
    ...
    function Bf(e, r) {
      ...
      function u(i, o, s) {
        let l = o.length,
          ...
          E;
        if (
          (o.charCodeAt(D) === Ri && ((f = !0), D++), o.charCodeAt(D) === Yr)
        ) {
          if ((D++, f))
            return s ? !0 : i(o.slice(0, D))({ type: "text", value: "$" });
          if (
            (o.charCodeAt(D) === Yr && ((c = !0), D++),
            (d = o.charCodeAt(D)),
            !(d === Ni || d === Ii))
          ) {
            for (m = D; D < l; ) {
      ...
      if (
        ...
        for (s = 0, x = [], v = [], w = []; s < l; ) {
          ...
          if (
            ...
            if (E)
              if (((p = r.charAt(s)), p === Xr)) (f += xe - (f % xe)), s++;
              else if (p === de) {
      ...
      if (((f = r.charAt(u)), f === en)) {
        ...
        if (!(!c || r.charAt(u) !== gr || r.charAt(u + 1) !== eo)) {
          for (
            ...
            u < i && ((f = r.charAt(u)), !(f !== Qr && f !== Zr && f !== Ke));
          ...
          if (((c = r.charAt(i)), !(!o || c !== nn)))
            return t
              ...
              : ((l += o),
                ...
                f.offset++,
                s &&
                  (l.slice(0, rt).toLowerCase() === an
                    ? ((D = D.slice(rt)), (f.column += rt), (f.offset += rt))
                    : (l = an + l)),
        ...
        if (((s = F), (D = F), (u = r.charAt(i)), u === ut)) {
          ...
          if (((u = r.charAt(i)), u === nt)) {
            for (
              ...
              u === it && ((h += it), (u = r.charAt(++i))), (h += u), i++;
            (u = r.charAt(i)),
              u === ut ? ((f = h ? gn : r0), (F += h + u), i++) : (h = ""),
              (s += F),
              (F = "");
          } else {
            if (!D) return;
    ...
    function Cs(e, r, t) {
      ...
      if (
        ...
        for (
          ...
          if (((a = r.charAt(s)), a === at && u === at && (!i || !vs(i))))
            return t
              ? !0
              : e(Es + o + Es)({
                  type: "delete",
    ...
    function Pc() {
      ...
      function s(m) {
        ...
        function b(g, A) {
          var x = l(g);
          x
            ? (qc(x[1]) && qc(A) && (A = lt(!0, x[1], A)), (x[1] = A))
      ...
      function f(m, F, y) {
        if (
          (_c(m),
          i(),
          !y && typeof F == "function" && ((y = F), (F = null)),
          !y)
        )
...
`)
  ...
  function ye(e, r) {
    return (function t(n, a, u) {
      ...
      return (
        i.children &&
          (i.children = i.children.map((o, s) => t(o, s, [i, ...u]))),
        i
      );
    })(e, null, []);
  }
...
`,
        ...
        case J: {
          ...
          let x = { ind: D, mode: h, doc: Ee(m) },
            v = m[0];
          Nr({ ind: D, mode: ne, doc: [F, y, v] }, [], d, l.length > 0, t, !0)
            ? i.push(x, g, E)
            : b
              ? i.push(x, A, E)
              : i.push(x, A, B);
...
`,
      ...
      case "definition": {
        ...
        return ze([
          bt(n),
          ":",
          Ze([i, Ct(n.url), n.title === null ? "" : [i, Rr(n.title, r, !1)]]),
        ]);
      }
      case "footnote":
        return ["[^", V(e, r, t), "]"];
...
`,
  ...
  function Am() {
    return (e) =>
      ye(e, (r, t, [n]) =>
        r.type !== "html" || Rc.test(r.value) || Pr.has(n.type)
          ? r
          : { ...r, type: "jsx" },
      );
  }

...
function St(e, t) {
  ...
  if (r.length === 1) {
    ...
    return r[2] && !Ce(r[2])
      ? !1
      : (r.length === 2 ? _t(r[1]) : fo(r[1]) && K(r[1]).length <= 1) ||
          Ln(r[1]);
  return !1;
}
var pu = (e) => (t) => (
...
`),
  ...
  return q(e)
    ...
    : (e.type === "UnaryExpression" && xo.has(e.operator)) ||
  ...
  e.type === "TaggedTemplateExpression" &&
    ...
    e.type === "TemplateLiteral" &&
      (((u = e.leadingComments) != null &&
        u.some(
          (a) => re(a) && ["GraphQL", "HTML"].some((o) => a.value === ` ${o} `),
        )) ||
...
function Io(e) {
  if ((e.type === le && e.break) || (e.type === me && e.hard) || e.type === ve)
    return !0;
}
function ne(e) {
  return gu(e, Io, !1);
...
function Go(e) {
  return [No, _u, Lu, vu, Yn, Hn, Iu, wu, ju, tp, np, $n, op, Vn, lp, mp].some(
    (t) => t(e),
  );
}
function Uo(e) {
...
function rp({
  ...
  return Ne(r)
    ? (sr(e) && ((n.prettierIgnore = !0), (e.unignore = !0)),
      t ? (z(t, e), !0) : !1)
    : (Ne(n) && sr(e) && ((n.types[0].prettierIgnore = !0), (e.unignore = !0)),
      !1);
}
...
function op({ comment: e, enclosingNode: t, followingNode: r }) {
  return ip.has(t == null ? void 0 : t.type) && r && (ap.has(r.type) || re(e))
    ? (ce(r, e), !0)
    : !1;
}
          ...
          case Se:
            ...
            p.literal
              ? y.root
                ...
                : (a.push(s), (u = 0))
              : ((u -= Zn(a)), a.push(s + y.value), (u = y.length));
            break;
        }
        break;
      case je:
  ...
  if (s.length > 1 || s.some((u) => u.length > 0)) {
    ...
    let i = [],
      a = u.map(
        (y) =>
          "${" +
          es(y, { ...t, printWidth: Number.POSITIVE_INFINITY, endOfLine: "lf" })
            .formatted +
          "}",
      ),
...
function Wr(e, t) {
  return mt(e, (r) =>
    typeof r == "string" ? (t ? N(!1, r, /(\\*)`/gu, "$1$1\\`") : ts(r)) : r,
  );
}
function ts(e) {
...
function Nu(e) {
  let t = (n) => n.type === "TemplateLiteral",
    r = (n, s) =>
      ...
      s === "value";
  return (
    e.match(t, (n, s) => U(n) && s === "elements", r, ...ns) ||
    e.match(t, r, ...ns)
  );
}
function Xu(e) {
...
function Gr({ node: e, parent: t }, r) {
  return (
    rs(e, r) ||
    (Sp(t) && rs(t, r)) ||
    (t.type === "ExpressionStatement" && rs(t, r))
  );
}
function Sp(e) {
  return (
...
`),
    ...
    let B = null;
    S ? (B = Op(y)) : (B = await e(D, { parser: "graphql" })),
      B
        ? ((B = Wr(B, !1)),
          !c && A && i.push(""),
          i.push(B),
...
function us(e, t) {
  ...
  if (t.__isInHtmlInterpolation && !t.bracketSpacing && nc(r) && or(e))
    return !0;
  if (ec(r)) return !1;
  ...
  switch (r.type) {
    ...
    case "BinaryExpression":
      if (s.type === "UpdateExpression" || (r.operator === "in" && tc(e)))
        return !0;
...
function li(e, t) {
  ...
  return r.type === "FunctionExpression" || r.type === "ClassExpression"
    ? n.type === "ExportDefaultDeclaration" || !us(e, t)
    : !jt(r) || (n.type !== "ExportDefaultDeclaration" && us(e, t))
      ? !1
      : e.call(() => li(e, t), ...Pr(r));
}
function sc(e) {
...
function uc(e) {
  return (
    ...
    is(e) || (L(e) && !e.optional && is(e.callee))
  );
}
var Be = us;
function ic(e, t) {
...
function pc(e, t, r) {
  ...
  return !o || (r != null && r.hasLineSuffix)
    ? { doc: [Wn([" ", s]), Ee], isBlock: o, hasLineSuffix: !0 }
...
function cc(e, t, r) {
  ...
  n.children = n.children.map((h) =>
    Sc(h) ? { type: "JSXText", value: " ", raw: " " } : h,
  );
  let i = n.children.some(X),
    a =
      n.children.filter((h) => h.type === "JSXExpressionContainer").length > 1,
      ...
      if (i.type === "JSXText") {
        ...
        if (pr(i)) {
          ...
          c[0] === "" &&
            ...
            c.shift());
          let m;
          if ((O(!1, c, -1) === "" && (c.pop(), (m = c.pop())), c.length === 0))
            return;
...
function ys(e, t, r, n, s) {
  ...
  nr(u.operator, u.left.operator)
    ? (i = e.call((T) => ys(T, t, r, !0, s), "left"))
    : i.push(l(t("left")));
  let a = Ut(u),
    o =
      (u.operator === "|>" || u.type === "NGPipeExpression" || Pc(e, r)) &&
...
function Oc(e) {
  ...
  let [t, r] = e;
  return t.type === "ModuleExpression" && vc(r)
    ? !0
    : !d(t) &&
  ...
  let n = r("object"),
    ...
    o =
      ...
      ((a.type === "AssignmentExpression" || a.type === "VariableDeclarator") &&
        (Mc(u.object) || ((c = n.label) == null ? void 0 : c.memberChain)));
...
function Pi(e, t, r) {
  ...
  if (c.length <= j && !W && !c.some((I) => O(!1, I, -1).hasTrailingEmptyLine))
    return Or(e) ? J : l(J);
...
function Jc(e, t, r, n, s) {
  ...
  if (
    e.match(
      ...
      (y) =>
        !a ||
        (y.type !== "ExpressionStatement" && y.type !== "VariableDeclaration"),
    )
  )
    return a
...
function qc(e, t, r, n) {
  ...
  switch (s.type) {
    ...
    case "ConditionalExpression": {
      ...
      return (
        a.type === "ConditionalExpression" || o.type === "ConditionalExpression"
      );
    }
    case "ClassExpression":
...
function ji(e, t, r, n = !1) {
  ...
  if (L(s)) {
    ...
    let o = oe(s);
    return !(o.length === 0 || (o.length === 1 && rr(o[0], t))) || Vc(s, r)
      ? !1
      : e.call(u, "callee");
  }
  return q(s)
...
function $(e) {
  let { node: t } = e;
  return t.declare ||
    (sl.has(t.type) && e.parent.type !== "DeclareExportDeclaration")
    ? "declare "
    : "";
}
var ul = new Set([
  ...
  if (o.length === 0) s.push(il(e, t, u, i));
    ...
    s.push(
      l(
        [
          u,
          f([E, p ? ol(e, t, r, A) : [al(e, t, a, n.inexact, r), A], M(e, t)]),
          E,
          i,
        ],
        { shouldBreak: C, id: y },
...
function Pt(e, t, r, n) {
  ...
  if (
    ...
    (!i &&
      (u ||
        (s[n].length === 1 &&
          (s[n][0].type === "NullableTypeAnnotation" || As(s[n][0])))))
  )
    return ["<", P(", ", e.map(r, n)), Sl(e, t), ">"];
  let o =
    s.type === "TSTypeParameterInstantiation"
      ? ""
      : gl(e, t, n)
...
function ta(e) {
  return (
    e.typeParameters && !d(e.typeParameters, g.Trailing | g.Line) && !Bl(e)
  );
}
function hs(e, t, r, n) {
  let { node: s } = e;
...
function dn(e, t, r) {
  let { node: n } = e,
    s = [];
  return (
    w(n.decorators) && s.push(Ds(e, t, r)),
    s.push(Xt(n)),
  ...
  return e.match((h) => h.type === "ObjectPattern" && !w(h.decorators), Is) ||
    ...
    (!y &&
      e.match(
        ...
        (h) =>
          h.type === "AssignmentExpression" || h.type === "VariableDeclarator",
      ))
    ? J
    : l(J, { shouldBreak: y });
}
...
function Vt(e, t, r, n) {
  ...
  let { node: s } = e,
    ...
    i =
      s.type === "TSConditionalType" || s.type === "ConditionalTypeAnnotation",
  ...
  let vs = Symbol("test"),
    ...
    Ra = u
      ? [Ls(r("test")), s.test.type === "ConditionalExpression" ? Ee : ""]
      : [
          r("checkType"),
          " ",
          "extends",
    ...
    qa = xt
      ? l([Ms, _ ? Cr : b(Cr, l(Cr, { id: Ma }), { groupId: vs })], { id: Fr })
      : [Ms, Cr],
    kn = r(o),
      ...
      if ((i.push("await"), s.argument)) {
        ...
        if ((L(a) && a.callee === s) || (q(a) && a.object === s)) {
          ...
          let o = e.findAncestor(
            (c) => c.type === "AwaitExpression" || c.type === "BlockStatement",
          );
          if (
...
function ka(e, t, r) {
  ...
  switch (n.type) {
    ...
    case "TSModuleDeclaration": {
      ...
      return (
        u.push(r("id")),
        c ? u.push(r("body")) : n.body ? u.push(" ", l(r("body"))) : u.push(s),
        u
      );
    }
    case "TSConditionalType":
